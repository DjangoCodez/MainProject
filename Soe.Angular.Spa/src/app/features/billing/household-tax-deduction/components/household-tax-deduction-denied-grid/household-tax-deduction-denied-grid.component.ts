...
@Component({
  selector: 'soe-household-tax-deduction-denied-grid',
  templateUrl: './household-tax-deduction-denied-grid.component.html',
  providers: [FlowHandlerService, ToolbarService],
  standalone: false,
})
export class HouseholdTaxDeductionDeniedGridComponent
...
{
  // classification
  classification: number = SoeHouseholdClassificationGroup.Denied;
  ...
  override onGridReadyToDefine(
    ...
    this.translate
      ...
      .subscribe(terms => {
        ...
        this.grid.addColumnDate(
          'deniedDate',
          terms['billing.invoices.householddeduction.denieddate'],
          {
            flex: 1,
            enableGrouping: true,
          }
