...
export class TabsController implements ICompositionTabsController {
    ...
    constructor(private urlHelperService: IUrlHelperService,
        ...
        // Setup base class
        var part: string = "billing.invoices.textblocks.";

        this.tabs = tabHandlerFactory.create()
            .onGetRowIdentifier(row => row.textblockId)
            .onGetRowEditName(row => row.headline)
            ...
            .initialize(part + "textblock", part + "textblocks", part + "new_textblock");
    }
