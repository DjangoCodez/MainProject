...
export class PayrollProductAccountingPriorityDirectiveFactory {
    //@ngInject
    public static create(translationService: ITranslationService, urlHelperService: IUrlHelperService): ng.IDirective {

        return {
            templateUrl: urlHelperService.getGlobalUrl('Billing/Projects/Directives/PayrollProductAccountingPriority.html'),
            scope: {
                payrollProductAccountPriorityRows: '=',
                readOnly: '=?',
            },
            restrict: 'E',
            replace: true,
...
class AccountingPriorityDirectiveController extends GridControllerBase {
    // Setup
    private payrollProductAccountPriorityRows: any[];
    ...
    constructor($http,
        ...
        super("Billing.Projects.List.PayrollProductAccountingPriority", "", Feature.None, $http, $templateCache, $timeout, $uibModal, coreService, translationService, urlHelperService, messagingService, notificationService, uiGridConstants);
    ...
    private setupGridColumns() {
        ...
        this.translationService.translateMany(keys).then(terms => {
            ...
            super.gridDataLoaded(this.payrollProductAccountPriorityRows);
        });
    }
