...
export class TabsController implements ICompositionTabsController {
    ...
    constructor(private urlHelperService: IUrlHelperService,
        ...
        // Setup base class
        var part: string = "billing.stock.stockinventory.";

        this.tabs = tabHandlerFactory.create()
            .onGetRowIdentifier(row => row.stockInventoryHeadId)
            ...
            .initialize(part + "stockinventory", part + "stockinventory", part + "new_stockinventory");
    }
