...
export class AbsenceRequestReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: AbsenceRequestReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/AbsenceRequestReport/AbsenceRequestReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "absenceRequestReport";
