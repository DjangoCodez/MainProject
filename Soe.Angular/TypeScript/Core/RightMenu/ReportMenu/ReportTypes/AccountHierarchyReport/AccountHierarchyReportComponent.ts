...
export class AccountHierarchyReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: AccountHierarchyReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/AccountHierarchyReport/AccountHierarchyReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "accountHierarchyReport";
