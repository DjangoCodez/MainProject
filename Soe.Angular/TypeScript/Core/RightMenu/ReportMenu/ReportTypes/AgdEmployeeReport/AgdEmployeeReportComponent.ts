...
export class AgdEmployeeReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: AgdEmployeeReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/AgdEmployeeReport/AgdEmployeeReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "agdEmployeeReport";
    ...
    public onBoolSelectionIncludeAbsence(selection: IBoolSelectionDTO) {
