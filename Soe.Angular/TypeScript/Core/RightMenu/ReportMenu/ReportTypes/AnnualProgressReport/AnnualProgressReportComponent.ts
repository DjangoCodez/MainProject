...
export class AnnualProgressReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: AnnualProgressReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/AnnualProgressReport/AnnualProgressReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "annualProgressReport";
