...
export class InvoiceProductUnitConvertReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: InvoiceProductUnitConvertReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/Billing/InvoiceProductUnitConvertReport/InvoiceProductUnitConvertReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static readonly componentKey = "invoiceProductUnitConvertReport";
