...
import { AccountIntervalSelectionDTO, BoolSelectionDTO, DateRangeSelectionDTO, AccountFilterSelectionDTO, AccountFilterSelectionsDTO, TextSelectionDTO, IdSelectionDTO, IdListSelectionDTO } from "../../../../../../Common/Models/ReportDataSelectionDTO";
...
export class ProjektstatistikReport {
    selectedProject: SmallGenericType;
    public static component(): ng.IComponentOptions {
        return {
            controller: ProjektstatistikReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/Billing/ProjektstatistikReport/ProjektstatistikReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "projektstatistikReport";
