...
export class SalesStatistikReport {
    ...
    public static component(): ng.IComponentOptions {
        return {
            controller: SalesStatistikReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/Billing/SalesStatistikReport/SalesStatistikReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<",
            }
    ...
    public static componentKey = "salesStatistikReport";
    ...
    projects: any[] = [];
    projectId: number;
    private projectNrFrom: SmallGenericType;
    private projectNrTo: SmallGenericType;
    ...
    public onProjectFromSelected(selection: SmallGenericType) {
        this.selections.upsert(Constants.REPORTMENU_SELECTION_KEY_PROJECT_NUMBER_FROM, new IdSelectionDTO(selection.id));
    ...
    public onProjectToSelected(selection: SmallGenericType) {
        this.selections.upsert(Constants.REPORTMENU_SELECTION_KEY_PROJECT_NUMBER_TO, new IdSelectionDTO(selection.id));
    }
