...
export class StockListReport {
    selectableSorting: ISmallGenericType[];
    selectableInventoryBalanceList: any[];
    selectableCodeList: any[];
    public static component(): ng.IComponentOptions {
        return {
            controller: StockListReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/Billing/StockListReport/StockListReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<",
            }
    ...
    public static componentKey = "stockListReport";
