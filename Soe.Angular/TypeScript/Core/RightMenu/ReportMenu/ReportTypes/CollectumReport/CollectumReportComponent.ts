...
export class CollectumReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: CollectumReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/CollectumReport/CollectumReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "collectumReport";
