...
export class CustomerReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            ...
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/Economy/CustomerReport/CustomerReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "customerReport";
