...
export class PeriodAccountingRegulationsReport {
    public static component(): ng.IComponentOptions {
        return {
            controller: PeriodAccountingRegulationsReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/Economy/PeriodAccountingRegulationsReport/PeriodAccountingRegulationsReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "periodAccountingRegulationsReport";
