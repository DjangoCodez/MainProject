...
export class TaxReturnReport {
    public static component(): ng.IComponentOptions {
        return {
            controller: TaxReturnReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/Economy/TaxReturnReport/TaxReturnReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "taxReturnReport";
    ...
    constructor(private $scope: ng.IScope, $timeout: ng.ITimeoutService, private translationService: ITranslationService, private reportDataService: IReportDataService) {
        ...
        this.$scope.$watch(() => this.userSelection, (newVal, oldVal) => {
            ...
            this.createVatVoucher = this.userSelection.getBoolSelection(Constants.REPORTMENU_SELECTION_KEY_CREATE_VAT_VOUCHER);
        });
    ...
    public onBoolSelectionCreateVatVoucher(selection: IBoolSelectionDTO) {
        this.selections.upsert(Constants.REPORTMENU_SELECTION_KEY_CREATE_VAT_VOUCHER, selection);
    }
}
