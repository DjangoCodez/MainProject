...
export class EmployeePayrollAdditionsReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: EmployeePayrollAdditionsReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/EmployeePayrollAdditionsReport/EmployeePayrollAdditionsReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "employeePayrollAdditionsReport";
    ...
    private userSelectionInputShowOnlyWithAdditions: BoolSelectionDTO;
    ...
    constructor(
        ...
        this.$scope.$watch(() => this.userSelection, (newVal, oldVal) => {
            ...
            this.userSelectionInputShowOnlyWithAdditions = this.userSelection.getBoolSelection(Constants.REPORTMENU_SELECTION_KEY_ONLY_EMPLOYEES_WITH_ADDITIONS);
    ...
    public onBoolSelectionInputShowOnlyWithAdditions(selection: BoolSelectionDTO) {
        this.selections.upsert(Constants.REPORTMENU_SELECTION_KEY_ONLY_EMPLOYEES_WITH_ADDITIONS, selection);
    }
}
