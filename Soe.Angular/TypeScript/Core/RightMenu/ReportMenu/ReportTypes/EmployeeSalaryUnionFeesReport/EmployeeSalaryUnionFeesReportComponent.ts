...
export class EmployeeSalaryUnionFeesReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: EmployeeSalaryUnionFeesReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/EmployeeSalaryUnionFeesReport/EmployeeSalaryUnionFeesReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "employeeSalaryUnionFeesReport";
