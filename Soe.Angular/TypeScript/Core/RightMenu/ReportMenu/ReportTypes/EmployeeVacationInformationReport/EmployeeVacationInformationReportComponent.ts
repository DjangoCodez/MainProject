...
export class EmployeeVacationInformationReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: EmployeeVacationInformationReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/EmployeeVacationInformationReport/EmployeeVacationInformationReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "employeeVacationInformationReport";
