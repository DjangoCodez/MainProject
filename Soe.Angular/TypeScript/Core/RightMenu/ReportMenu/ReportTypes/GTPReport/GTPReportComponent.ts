...
export class GTPReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: GTPReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/GTPReport/GTPReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "gTPReport";
