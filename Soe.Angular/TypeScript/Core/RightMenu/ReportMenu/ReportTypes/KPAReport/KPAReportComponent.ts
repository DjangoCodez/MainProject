...
export class KPAReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: KPAReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/KPAReport/KPAReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "kPAReport";
