...
export class KronofogdenReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: KronofogdenReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/KronofogdenReport/KronofogdenReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "kronofogdenReport";
