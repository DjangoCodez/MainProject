...
export class Ku10Report {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: Ku10Report,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/Ku10Report/Ku10ReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "ku10Report";
