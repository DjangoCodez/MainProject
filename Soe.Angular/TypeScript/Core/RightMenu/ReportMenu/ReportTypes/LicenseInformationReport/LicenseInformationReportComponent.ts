...
export class LicenseInformationReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: LicenseInformationReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/LicenseInformationReport/LicenseInformationReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "licenseInformationReport";
