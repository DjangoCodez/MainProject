...
export class OrganisationHrReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: OrganisationHrReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/OrganisationHrReport/OrganisationHrReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "organisationHrReport";
