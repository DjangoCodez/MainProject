...
export class PayrollPeriodWarningCheckReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: PayrollPeriodWarningCheckReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/PayrollPeriodWarningCheckReport/PayrollPeriodWarningCheckReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "payrollPeriodWarningCheckReport";
