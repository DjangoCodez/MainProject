...
import { DateRangeSelectionDTO, MatrixColumnsSelectionDTO } from "../../../../../Common/Models/ReportDataSelectionDTO";
...
export class ReportStatisticsReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: ReportStatisticsReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/ReportStatisticsReport/ReportStatisticsReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "reportStatisticsReport";
