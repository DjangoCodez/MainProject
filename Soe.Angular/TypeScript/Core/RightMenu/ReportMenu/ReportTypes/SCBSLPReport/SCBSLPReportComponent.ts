...
export class SCBSLPReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: SCBSLPReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/SCBSLPReport/SCBSLPReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "sCBSLPReport";
