...
export class SEFReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: SEFReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/SEFReport/SEFReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "sEFReport";
