...
export class SNReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: SNReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/SNReport/SNReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<"
            }
    ...
    public static componentKey = "sNReport";
