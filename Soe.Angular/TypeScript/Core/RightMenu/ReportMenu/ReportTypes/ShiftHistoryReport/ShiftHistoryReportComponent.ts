...
export class ShiftHistoryReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: ShiftHistoryReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/ShiftHistoryReport/ShiftHistoryReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "shiftHistoryReport";
