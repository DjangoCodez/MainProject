...
export class ShiftQueueReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: ShiftQueueReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/ShiftQueueReport/ShiftQueueReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "shiftQueueReport";
