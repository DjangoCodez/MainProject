...
export class ShiftRequestReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: ShiftRequestReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/ShiftRequestReport/ShiftRequestReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "shiftRequestReport";
