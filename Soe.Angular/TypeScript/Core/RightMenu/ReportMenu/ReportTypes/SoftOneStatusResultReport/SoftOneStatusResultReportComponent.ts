...
export class SoftOneStatusResultReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: SoftOneStatusResultReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/SoftOneStatusResultReport/SoftOneStatusResultReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "softOneStatusResultReport";
