...
export class SoftOneStatusUpTimeReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: SoftOneStatusUpTimeReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/SoftOneStatusUpTimeReport/SoftOneStatusUpTimeReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "softOneStatusUpTimeReport";
