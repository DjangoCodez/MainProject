...
export class StaffingneedsFrequencyReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: StaffingneedsFrequencyReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/StaffingneedsFrequencyReport/StaffingneedsFrequencyReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "staffingneedsFrequencyReport";
