...
export class VerticalTimeTrackerReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: VerticalTimeTrackerReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/Time/VerticalTimeTrackerReport/VerticalTimeTrackerReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "verticalTimeTrackerReport";
    ...
    private userSelectionInputSelectionIsFillDay: BoolSelectionDTO;
    ...
    constructor(
        ...
        this.$scope.$watch(() => this.userSelection, (newVal, oldVal) => {
            ...
            this.userSelectionInputSelectionIsFillDay = this.userSelection.getBoolSelection(Constants.REPORTMENU_SELECTION_KEY_TIME_SELECTIONFILLDAY);
    ...
    public onBoolSelectionInputSelectionIsFillDay(selection: IBoolSelectionDTO) {
        this.selections.upsert(Constants.REPORTMENU_SELECTION_KEY_TIME_SELECTIONFILLDAY, selection);
    }
