...
export class TimeAccumulatorDetailedReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: TimeAccumulatorDetailedReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/TimeAccumulatorDetailedReport/TimeAccumulatorDetailedReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<",
                fromDate: "<",
    ...
    public static componentKey = "timeAccumulatorDetailedReport";
