...
export class TimeCategoryStatisticsReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: TimeCategoryStatisticsReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/TimeCategoryStatisticsReport/TimeCategoryStatisticsReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<",
                fromDate: "<",
    ...
    public static componentKey = "timeCategoryStatisticsReport";
