...
export class TimeScheduleBlockHistoryReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: TimeScheduleBlockHistoryReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/TimeScheduleBlockHistoryReport/TimeScheduleBlockHistoryReportView.html",
            bindings: {
                userSelection: "=",
                selections: "<",
                fromDate: "<",
    ...
    public static componentKey = "timeScheduleBlockHistoryReport";
