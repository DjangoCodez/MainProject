...
export class VismaPayrollChangesReport {
    public static component(): ng.IComponentOptions {
        const options: ng.IComponentOptions = {
            controller: VismaPayrollChangesReport,
            templateUrl: soeConfig.baseUrl + "Core/RightMenu/ReportMenu/ReportTypes/VismaPayrollChangesReport/VismaPayrollChangesReportView.html",
            bindings: {
                module: "<",
                userSelection: "=",
                selections: "<",
    ...
    public static componentKey = "vismaPayrollChangesReport";
