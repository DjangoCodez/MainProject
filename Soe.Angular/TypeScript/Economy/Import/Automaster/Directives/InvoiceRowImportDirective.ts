...
export class InvoiceRowImportDirectiveFactory {
    //@ngInject
    public static create(translationService: ITranslationService, urlHelperService: IUrlHelperService): ng.IDirective {

        return {
            templateUrl: urlHelperService.getGlobalUrl('Economy/Import/Automaster/Directives/InvoiceRowImport.html'),
            scope: {
                rows: '=',
                readOnly: '=?',
            },
            restrict: 'E',
            replace: true,
            controller: InvoiceRowImportDirectiveController,
            controllerAs: 'ctrl',
...
class InvoiceRowImportDirectiveController extends GridControllerBase {
    // Setup
    private rows: CustomerInvoiceRowIODTO[];
    private importHeadId: number;
    private readOnly: boolean;

    // Collections
    accountingRows: CustomerInvoiceRowIODTO[] = [];
    ...
    constructor($http,
        ...
        super("Soe.Economy.Import.Automaster.Directives.InvoiceRowImport", "", Feature.None, $http, $templateCache, $timeout, $uibModal, coreService, translationService, urlHelperService, messagingService, notificationService, uiGridConstants);
    ...
    private setupGridColumns() {
        ...
        this.translationService.translateMany(keys).then(terms => {
            ...
            var colDef2 = this.soeGridOptions.addColumnText("invoiceNr", terms["economy.import.automaster.invoicenr"], null);
            colDef2.enableCellEdit = true;
            var colDef7 = this.soeGridOptions.addColumnText("accountNr", terms["economy.import.automaster.claimaccount"], null);
            colDef7.enableCellEdit = true;
            var colDef8 = this.soeGridOptions.addColumnText("accountDim2Nr", terms["economy.import.automaster.acountdim2nr"], null);
            colDef8.enableCellEdit = true;
            var colDef5 = this.soeGridOptions.addColumnNumber("amount", terms["economy.import.automaster.totalamount"], null);
    ...
    protected allowNavigationFromTypeAhead(entity: CustomerInvoiceRowIODTO, colDef) {
        return true;
    }
