...
export class TabsController implements ICompositionTabsController {
    ...
    constructor(private urlHelperService: IUrlHelperService, tabHandlerFactory: ITabHandlerFactory) {
        // Setup base class
        var part: string = "economy.inventory.inventorywriteoffmethods.";

        this.tabs = tabHandlerFactory.create()
            .onGetRowIdentifier(row => row.inventoryWriteOffMethodId)
            ...
            .initialize(part + "inventorywriteoffmethod", part + "inventorywriteoffmethod", part + "new_inventorywriteoffmethod");
    }
