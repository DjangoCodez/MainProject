...
export class EditController extends EditControllerBase {
    ...
    constructor(
        ...
        super("Manage.Attest.Customer.Roles.Edit", Feature.Manage_Attest_Customer_AttestRoles_Edit, $uibModal, translationService, messagingService, coreService, notificationService, urlHelperService);
    }
