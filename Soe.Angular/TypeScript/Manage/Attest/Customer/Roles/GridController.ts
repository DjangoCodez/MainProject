...
export class GridController extends GridControllerBase2Ag implements ICompositionGridController {
    ...
    constructor(
        ...
        super(gridHandlerFactory, "Manage.Attest.Customer.Roles", progressHandlerFactory, messagingHandlerFactory);
    ...
    public onInit(parameters: any) {
        ...
        this.flowHandler.start([{ feature: Feature.Manage_Attest_Customer_AttestRoles, loadReadPermissions: true, loadModifyPermissions: true }]);
    }

    private onPermissionsLoaded(response: IPermissionRetrievalResponse) {
        this.readPermission = response[Feature.Manage_Attest_Customer_AttestRoles].readPermission;
        this.modifyPermission = response[Feature.Manage_Attest_Customer_AttestRoles].modifyPermission;
    ...
    public loadGridData() {
        this.progress.startLoadingProgress([() => {
            return this.attestService.getAttestRoles(SoeModule.Billing, false).then((x) => {
                this.setData(x);
            });
        }]);
    }
