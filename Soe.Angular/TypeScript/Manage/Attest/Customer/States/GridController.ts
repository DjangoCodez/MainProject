...
export class GridController extends GridControllerBase2Ag implements ICompositionGridController {
    ...
    constructor(
        ...
        super(gridHandlerFactory, "Manage.Attest.Customer.States", progressHandlerFactory, messagingHandlerFactory);
    ...
    onInit(parameters: any) {
        ...
        this.flowHandler.start({ feature: Feature.Manage_Attest_Customer_AttestStates, loadReadPermissions: true, loadModifyPermissions: true });
    }

    private onPermissionsLoaded(response: IPermissionRetrievalResponse) {
        this.readPermission = response[Feature.Manage_Attest_Customer_AttestStates].readPermission;
        this.modifyPermission = response[Feature.Manage_Attest_Customer_AttestStates].modifyPermission;
    ...
    public setupGrid() {
        ...
        this.translationService.translateMany(keys).then((terms) => {
            ...
            this.gridAg.addColumnBool("locked", terms["manage.attest.state.locked"], 25, false)
    ...
    public loadAttestEntities(): ng.IPromise<any> {
        return this.attestService.getAttestEntitiesGenericList(false, true, SoeModule.Billing).then((x) => {
    ...
    public loadGridData1(): ng.IPromise<any> {
        // Load data
       return this.progress.startLoadingProgress([() => {
            return this.attestService.getAttestStates(TermGroup_AttestEntity.Unknown, SoeModule.Billing, false).then((x) => {
                _.forEach(x, (y: any) => {
