...
export class TabsController implements ICompositionTabsController {
    ...
    constructor(private urlHelperService: IUrlHelperService, tabHandlerFactory: ITabHandlerFactory) {
        ...
        var part: string = "manage.attest.supplier.attestworkflowtemplate.";

        this.tabs = tabHandlerFactory.create()
            .onGetRowIdentifier(row => row.attestWorkFlowTemplateHeadId)
            ...
            .initialize(part + "attestworkflowtemplate", part + "attestworkflowtemplates", part + "new");
    }
