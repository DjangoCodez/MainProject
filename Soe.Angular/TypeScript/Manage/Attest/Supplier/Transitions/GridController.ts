...
export class GridController extends GridControllerBase2Ag implements ICompositionGridController {
    ...
    constructor(
        ...
        super(gridHandlerFactory, "Manage.Attest.Supplier.Transitions", progressHandlerFactory, messagingHandlerFactory);
    ...
    onInit(parameters: any) {
        ...
        this.flowHandler.start({ feature: Feature.Manage_Attest_Supplier_AttestTransitions, loadReadPermissions: true, loadModifyPermissions: true });
    }

    private onPermissionsLoaded(response: IPermissionRetrievalResponse) {
        this.readPermission = response[Feature.Manage_Attest_Supplier_AttestTransitions].readPermission;
        this.modifyPermission = response[Feature.Manage_Attest_Supplier_AttestTransitions].modifyPermission;
    ...
    public loadGridData() {
        ...
        this.progress.startLoadingProgress([() => {
            return this.attestService.getAttestTransitionGridDTOs(TermGroup_AttestEntity.Unknown, SoeModule.Economy, true).then((data) => {
                this.setData(data);
            });
        }]);
    }
