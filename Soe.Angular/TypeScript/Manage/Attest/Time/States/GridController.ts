...
export class GridController extends GridControllerBase2Ag implements ICompositionGridController {
    ...
    constructor(
        ...
        super(gridHandlerFactory, "Manage.Attest.Time.States", progressHandlerFactory, messagingHandlerFactory);
    ...
    onInit(parameters: any) {
        ...
        this.flowHandler.start({ feature: Feature.Manage_Attest_Time_AttestStates, loadReadPermissions: true, loadModifyPermissions: true });
    }

    private onPermissionsLoaded(response: IPermissionRetrievalResponse) {
        this.readPermission = response[Feature.Manage_Attest_Time_AttestStates].readPermission;
        this.modifyPermission = response[Feature.Manage_Attest_Time_AttestStates].modifyPermission;
    ...
    public loadAttestEntities(): ng.IPromise<any> {
        return this.attestService.getAttestEntitiesGenericList(false, true, SoeModule.Time).then((x) => {
