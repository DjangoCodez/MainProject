...
export class GridController extends GridControllerBase2Ag implements ICompositionGridController {
    ...
    constructor(
        ...
        super(gridHandlerFactory, "Manage.Registry.CompanyInformation", progressHandlerFactory, messagingHandlerFactory);
    ...
    private setupGrid() {
        ...
        return this.translationService.translateMany(keys).then(terms => {
            ...
            this.gridAg.finalizeInitGrid("core.informationmenu.companyinformation", true);
        });
    }
    ...
    public loadGridData() {
        this.progress.startLoadingProgress([() => {
            return this.registryService.getCompanyInformationGrids().then(x => {
                _.forEach(x, y => {
    ...
    private deleteInformations(informationIds: number[]) {
        return this.progress.startWorkProgress((completion) => {
            this.registryService.deleteCompanyInformations(informationIds).then(result => {
                if (result.success)
