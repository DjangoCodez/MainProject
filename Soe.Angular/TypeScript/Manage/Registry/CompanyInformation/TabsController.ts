...
import { EditController } from "../../../Core/RightMenu/InformationMenu/EditController";
...
export class TabsController implements ICompositionTabsController {
    ...
    constructor(private urlHelperService: IUrlHelperService,
        ...
        var part: string = "core.informationmenu.companyinformation.";
    ...
    private edit(row: any) {
        this.htmlEditorLoaderPromise.then(() => {
            // Open edit page
            this.tabs.addEditTab(row, EditController, null, this.urlHelperService.getGlobalUrl("Core/RightMenu/InformationMenu/edit.html"));
        });
    }

    private add(): Guid {
        return this.tabs.addCreateNewTab(EditController, this.urlHelperService.getGlobalUrl("Core/RightMenu/InformationMenu/edit.html"));
    }
