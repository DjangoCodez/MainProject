...
export class TabsController implements ICompositionTabsController {
    ...
    constructor(private urlHelperService: IUrlHelperService, tabHandlerFactory: ITabHandlerFactory) {
        var part: string = "manage.registry.externalcodes.";

        this.tabs = tabHandlerFactory.create()
            .onGetRowIdentifier(row => row.companyExternalCodeId)
            .onGetRowEditName(row => row.externalCode)
            ...
            .initialize(part + "externalcode", part + "externalcodes", part + "new");
    }
