...
export class GridController extends GridControllerBase2Ag implements ICompositionGridController {
    ...
    constructor(
        ...
        super(gridHandlerFactory, "Manage.Signing.Document.Transitions", progressHandlerFactory, messagingHandlerFactory);
    ...
    private onPermissionsLoaded(response: IPermissionRetrievalResponse) {
        this.readPermission = response[Feature.Manage_Signing_Document_Transitions].readPermission;
    ...
    public setupGrid() {
        ...
        this.translationService.translateMany(keys).then((terms) => {
            ...
            this.gridAg.finalizeInitGrid("manage.signing.transition.transitions", true);
        });
    }
    ...
    public loadGridData() {
        ...
        this.progress.startLoadingProgress([() => {
            return this.signingService.getAttestTransitionGridDTOs(TermGroup_AttestEntity.SigningDocument, SoeModule.Manage, true).then((data) => {
                this.setData(data);
            });
        }]);
    }
