...
export class TabsController implements ICompositionTabsController {
    ...
    constructor(private urlHelperService: IUrlHelperService, tabHandlerFactory: ITabHandlerFactory) {
        ...
        // Setup base class
        var part: string = "time.employee.employeecollectiveagreement.";

        this.tabs = tabHandlerFactory.create()
            .onGetRowIdentifier(row => row.employeeCollectiveAgreementId)
            ...
            .initialize(part + "employeecollectiveagreement", part + "employeecollectiveagreements", part + "new");
