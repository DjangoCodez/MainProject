...
export class TabsController implements ICompositionTabsController {
    ...
    constructor(
        ...
        var part: string = "time.payroll.payrollpriceformula.";

        this.tabs = tabHandlerFactory.create()
            .onGetRowIdentifier(row => row.payrollPriceFormulaId)
            ...
            .initialize(part + "payrollpriceformula", part + "payrollpriceformulas", part + "new");
    }
