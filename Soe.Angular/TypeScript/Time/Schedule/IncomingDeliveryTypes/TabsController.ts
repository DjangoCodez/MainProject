...
export class TabsController implements ICompositionTabsController {
    ...
    constructor(private urlHelperService: IUrlHelperService, tabHandlerFactory: ITabHandlerFactory) {
        ...
        var part: string = "time.schedule.incomingdeliverytype.";

        this.tabs = tabHandlerFactory.create()
            .onGetRowIdentifier(row => row.incomingDeliveryTypeId)
            ...
            .initialize(part + "incomingdeliverytype", part + "incomingdeliverytype", part + "new_incomingdeliverytype");
    }
