...
export class TabsController implements ICompositionTabsController {
    ...
    constructor(private urlHelperService: IUrlHelperService, tabHandlerFactory: ITabHandlerFactory) {
        ...
        // Setup base class
        var part: string = "time.schedule.staffingneedslocationgroup.";
        this.tabs = tabHandlerFactory.create()
            .onGetRowIdentifier(row => row.staffingNeedsLocationGroupId)
            ...
            .initialize(part + "staffingneedslocationgroup", part + "staffingneedslocationgroups", part + "new");
    }
