...
export class GridController extends GridControllerBase2Ag implements ICompositionGridController {
    ...
    constructor(
        ...
        super(gridHandlerFactory, "Time.Time.TimeCodeAdditionDeductions", progressHandlerFactory, messagingHandlerFactory);
    ...
    onInit(parameters: any) {
        ...
        this.flowHandler.start({ feature: Feature.Time_Preferences_TimeSettings_TimeCodeAdditionDeduction, loadReadPermissions: true, loadModifyPermissions: true });
    }
    ...
    private setupGrid() {
        ...
        return this.translationService.translateMany(keys).then(terms => {
            ...
            this.gridAg.finalizeInitGrid("time.time.timecodeadditiondeductions.timecodeadditiondeductions", true, undefined, true);
        });
    }
    ...
    public loadGridData(useCache: boolean) {
        this.progress.startLoadingProgress([() => {
            return this.timeService.getTimeCodesGrid(SoeTimeCodeType.AdditionDeduction, false, true).then(x => {
                return x;
            }).then(data => {
                this.setData(data);
            });
