...
export class GridController extends GridControllerBase2Ag implements ICompositionGridController {
    ...
    constructor(
        ...
        super(gridHandlerFactory, "Time.Time.TimeCodeMaterials", progressHandlerFactory, messagingHandlerFactory);
    ...
    onInit(parameters: any) {
        ...
        this.flowHandler.start({ feature: Feature.Billing_Preferences_ProductSettings_MaterialCode, loadReadPermissions: true, loadModifyPermissions: true });
    }
    ...
    private setupGrid() {
        ...
        return this.translationService.translateMany(keys).then(terms => {
            ...
            this.gridAg.finalizeInitGrid("time.time.timecodematerials.timecodematerials", true, undefined, true);
        });
    }
    ...
    public loadGridData(useCache: boolean) {
        this.progress.startLoadingProgress([() => {
            return this.timeService.getTimeCodesGrid(SoeTimeCodeType.Material, false, false).then(x => {
                return x;
            }).then(data => {
                this.setData(data);
            });
