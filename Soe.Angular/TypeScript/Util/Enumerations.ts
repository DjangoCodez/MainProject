...
export enum SchedulePlanningFunctions {
    ...
    AllocateLeisureCodes = 34,
    DeleteLeisureCodes = 35,
    RecalculateAnnualLeaveBalances = 36,
}
...
export enum OrderEditTransferFunctions {
    ...
    TransferToOrder = 3,
    DirectTransferToInvoice = 4,
    TransferToServiceOrderFromAgreement = 5,
    TransferToPriceOptimization = 6,
}
...
export enum CustomerInvoiceGridButtonFunctions {
    ...
    ExportFortnox = 36,
    ExportZetes = 37,
    ExportVismaEAccounting = 38,
    AutomaticDistribution = 39,
    CreateServiceOrderFromAgreement = 40,
}
...
export enum PayrollCalculationFunctions {
    ...
    AttestReminder = 7,
    ClearPayrollCalculation = 8,
    RunPayrollControll = 9,
}
