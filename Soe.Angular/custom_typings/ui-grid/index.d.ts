...
declare namespace uiGrid {
    ...
    export module grouping {
         ...
         */
        export interface IUiGridGroupingConstants extends ISharedTreeConstants {
            featureName: string;
        }
    }
    ...
    export module saveState {
        ...
        export interface ISavedScrollFocus {
            focus?: boolean;
            colName?: string;
            rowVal?: IRowVal;
        }

        export interface IRowVal {
            identity: boolean;
            row: number | any;
        }
    }
    ...
    export interface IGridColumnOf<TEntity> {
         ...
         */
        getRenderContainer(): any; // @todo replace with export interface for render container
