...
{
    public class TBEl : IPriceListProvider
    {
        GenericProvider genProvider;
        public const string WHOLESELLERNAME = "TB el";
        ...
        private GenericProduct ReadLine(string line)
        {
            ...
            prod.Price = Convert.ToInt32(line.Substring(38, 8));
