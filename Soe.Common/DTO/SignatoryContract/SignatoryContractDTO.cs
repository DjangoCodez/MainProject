namespace SoftOne.Soe.Common.DTO.SignatoryContract
{
    ...
    [TSInclude]
    public class SignatoryContractDTO
    {
        ...
        public List<SignatoryContractRecipientDTO> Recipients { get; set; }
            = new List<SignatoryContractRecipientDTO>();
        ...
        public List<SignatoryContractDTO> SubContracts { get; set; } 
