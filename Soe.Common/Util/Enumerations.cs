...
namespace SoftOne.Soe.Common.Util
{
    ...
    {
        public static bool GetValue(object obj, out int value, Type enumType, string removeFromObject = "")
        {
            value = 0;
            bool valid = false;
            ...
            if (obj != null)
            {
                var objectValue = removeFromObject.Length > 0 ? obj.ToString().Replace(removeFromObject, "") : obj.ToString();
                if (Int32.TryParse(objectValue, out int id) && Enum.IsDefined(enumType, id))
                {
                    value = id;
                    valid = true;
                }
                try
                {
                    var asdasd = Enum.Parse(enumType, objectValue);
                    id = (int)asdasd;
        ...
        public static T GetValue<T>(string value) where T : struct, Enum
        {
            var type = typeof(T);
            try
            {
                ...
                else
                {
                    ...
                    if (match.Success)
                    {
                        ...
                        var newValue = value.Substring(0, value.Length - match.Groups[1].Length);
                        if (Enum.TryParse(newValue, out result))
                        {
                            return result;
                        }
                        else
                        {
                            // If parsing fails again, return the default value of the enum (0)
                            return (T)Enum.Parse(type, "0");
                        }
                    }
                    else
                    {
                        // If there are no digits at the end of the string, return the default value of the enum (0)
                        return (T)Enum.Parse(type, "0");
                    }
                }
            }
        ...
        public static List<string> GetNames<T>()
        {
            ...
            foreach (var value in values)
                names.Add(Enum.GetName(typeof(T), value));
        ...
        public static IEnumerable<T> FlagEnumToArray<T>(T enumeration)
        {
            IEnumerable<T> enums = enumeration.ToString().Split(new string[] { ", " }, StringSplitOptions.None).Select(a => (T)Enum.Parse(typeof(T), a, true));
            return enums;
        }

        public static T Convert<T>(int enumValue, T notDefinedState = default(T)) where T : struct, IConvertible
        {
            if (!typeof(T).IsEnum)
            {
            ...
            return Enum.IsDefined(typeof(T), enumValue) ? (T)Enum.ToObject(typeof(T), enumValue) : notDefinedState;
        }

        public static List<CustomerAccountType> GetCustomerAccountTypes()
        {
            return new List<CustomerAccountType>()
            {
        ...
        public static List<EmploymentAccountType> GetEmploymentAccountTypes()
        {
            return new List<EmploymentAccountType>()
            {
                EmploymentAccountType.Cost,
                EmploymentAccountType.Income,
                EmploymentAccountType.Fixed1,
                EmploymentAccountType.Fixed2,
                EmploymentAccountType.Fixed3,
                EmploymentAccountType.Fixed4,
                EmploymentAccountType.Fixed5,
                EmploymentAccountType.Fixed6,
                EmploymentAccountType.Fixed7,
                EmploymentAccountType.Fixed8
            };
        }

        public static List<EmployeeGroupAccountType> GetEmployeeGroupAccountTypes()
        {
            return new List<EmployeeGroupAccountType>()
            {
                EmployeeGroupAccountType.Cost,
                EmployeeGroupAccountType.Income
            };
        }

        public static List<InventoryAccountType> GetInventoryAccountTypes()
        {
            return new List<InventoryAccountType>()
            {
        ...
        public static List<ProductAccountType> GetProductAccountTypes()
        {
            return new List<ProductAccountType>()
            {
        ...
        public static List<ProductAccountType> GetPayrollProductAccountTypes()
        {
            return new List<ProductAccountType>()
            {
                ProductAccountType.Purchase,
        ...
        public static List<ProjectAccountType> GetProjectAccountTypes()
        {
            return new List<ProjectAccountType>()
            {
        ...
        public static List<SupplierAccountType> GetSupplierAccountTypes()
        {
            return new List<SupplierAccountType>()
            {
    ...
    #region AbsenceRequestPlanningAction

    public enum AbsenceRequestShiftPlanningAction
    {
    ...
    #region ActorConsent type

    public enum ActorConsentType
    {
        Unspecified = 0,
        EmployeePortrait = 1
    }
    ...
    #region AccountHierarchyParamType

    //See extensions AccountHierarchyParamType.GetDefaultValue when adding new values
    public enum AccountHierarchyParamType
    {
        None = 0,
    ...
    public enum ActionResultSelect
    {
        // Common errors
        Unknown = 0,
        EntityIsNull = 1,
    ...
    public enum ActionResultDelete
    {
        // Common errors
        Unknown = 0,
        EntityIsNull = 1,
    ...
    #region AngularJS Legacy

    // Open old AngularJS page in new browser tab from new Angular page

    public enum AngularJsLegacyType
    {
        None = 0,
    ...
    public enum AttestStatus_SupplierInvoice
    {
    ...
    public enum AttestFlow_ReplaceUserReason
    {
        Remove = 1,
        Transfer = 2,
    ...
    public enum SupplierInvoiceAccountRowAttestStatus
    {
        Unknown = 0,
        New = 1,
        Processed = 2,
    ...
    #region AttestPeriodType

    public enum AttestPeriodType
    {
        Unknown = 0,
        Day = 1,
        Week = 2,
    ...
    public enum AltInnPeriodTypeEnum
    {
        Månedlig = 5,
        ToMånedlig = 6,
        Årlig = 7
    ...
    #region BalanceSubmitType

    public enum BalanceSubmitType
    {
        Unknown = 0,
        Save = 1,
        LoadBalance = 2,
    ...
    #region BalanceErrorStatus

    public enum BalanceErrorStatus
    {
        Ok = 0,
        Unknown = 1,
    ...
    public enum DistributionCodeBudgetType
    {
        AccountingBudget = 1,
        TimeBudget = 2,
        ProjectBudget = 3,
    ...
    public enum BudgetHeadStatus
    {
        Preliminary = 1,
        Active = 2,
    }

    public enum BudgetRowPeriodType
    {
        None = 0,
        Year = 1,
        SixMonths = 2,
    ...
    #region CalculationRowGroupByType

    public enum CalculationPeriodItemGroupByType
    {
        Unknown = 0,
        NoGrouping = 1,
        ShiftType = 2,
    ...
    public enum CaseProjectNoteType
    {
        Unknown = 0,
        ActionPerformed = 1,
        ExpectedResult = 2,
    ...
    public enum CaseProjectDisplayMode
    {
        User = 1,
        Admin = 2
    }

    public enum CaseProjectGridType
    {
        New = 0,
        My = 1,
        Open = 2,
    ...
    public enum ClientManagementResourceType
    {
    ...
    #region CompTermsRecordType

    public enum CompTermsRecordType
    {
        Unknown = 0,
        ProductName = 1,
        ProductUnitName = 2,
    ...
    public enum TemplateCompanyCopy
    {
        All = 1,
    ...
    public enum ChildCopyItemRequestType
    {
        None = 0,
    ...
    public enum CompanyGroupTransferType
    {
        None = 0,
        Consolidation = 1,
        Budget = 2,
    ...
    public enum CompanyGroupTransferStatus
    {
        None = 0,
        Transfered = 1,
        PartlyDeleted = 2,
    ...
    public enum DashboardStatisticsRowType
    {
        TimeValue = 0,
    }
    ...
    public enum DailyRecurrencePatternWeekIndex
    {
        First = 0,
        Second = 1,
        Third = 2,
    ...
    public enum DailyRecurrenceRangeType
    {
    ...
    public enum EdiRecivedMsgState
    {
        Unknown = 0,
        UnderProgress = 1,
        Transferred = 2,
    ...
    public enum SoeEDIClassificationGroupStatus
    {
        Unknown = 0,
        InProgress = 1,
        Done = 2,
    ...
    public enum EmployeeFactorDisplayMode
    {
        Absence = 1,
        Vacation = 2,
    }
    ...
    public enum EmployeePostSortType
    {
        Unknown = 0,
        Uniques = 1,
        CompareScore = 2,
    ...
    public enum EmployeeUserEditDisplayMode
    {
        Employee = 1,
        User = 2
    }

    public enum SaveEmployeeUserResult
    {
    ...
    public enum DeleteEmployeeAction
    {
        Cancel = 0,
        Inactivate = 1,
        RemoveInfo = 2,
    ...
    public enum SupplierInvoiceRowType
    {
        Unknown = 0,
        ProductRow = 1,
        TextRow = 2,
    ...
    public enum SupplierInvoiceCostLinkType
    {
        Undefined = 0,
        OrderRow = 1,
        ProjectRow = 2,
    ...
    // See also TermGroup_InventoryLogType
    public enum SoeAccountDistributionType
    {
        Auto = 1,
        Period = 2,
    ...
    /// <summary>
    /// Type for table Category (i.e. the different registrys)
    /// </summary>
    public enum SoeCategoryType
    {
        Unknown = 0,
        Product = 1,
        Customer = 2,
    ...
    /// <summary>
    /// Entity for table CompanyCategoryRecord (i.e. the different entities that uses the types in SoeCategoryType)
    /// </summary>
    public enum SoeCategoryRecordEntity
    {
        Unknown = 0,
        Product = 1,
        Customer = 2,
    ...
    public enum SoeInvoiceDeliveryType
    {
        Unknown = 0,
        Print = 1,
        Email = 2,
    ...
    public enum SoeInvoiceDeliveryProvider
    {
        Unknown = 0,
        Inexchange = 1,
        Intrum = 2,
    }
    public enum SoeInvoicePaymentServiceType
    {
        Unknown = 0,
        Autogiro = 1,
    }

    public enum SoeProjectRangeType
    {
        Unknown = 0,
        External = 1,
        Internal = 2,
    ...
    public enum SoeOriginInvoiceMappingType
    {
        //OBS! Changes here also affects SQL-views!
    ...
    public enum SoeEntityImageType
    {
        Unknown = 0,
        Inventory = 1,
        EmployeePortrait = 2,
    ...
    public enum StaffingNeedsFrequencyType
    {
        Unknown = 0,
        NbrOfItems = 1,
        NbrOfCustomers = 2,
    ...
    public enum SupplierInvoiceOrderLinkType
    {
        LinkToOrder = 0,
        LinkToProject = 1,
        Transfered = 2
    ...
    public enum SoeEntityStateTransition
    {
        None = 0,
        ActiveToInactive = 1,
        ActiveToDeleted = 2,
    ...
    public enum SoeHouseholdClassificationGroup
    {
        None = 0,
        Apply = 1,
        Applied = 2,
    ...
    public enum SoeOriginStatusGroup
    {
        None = 0,
        GeneralStart = 1,
        GeneralStop = 10,
    ...
    public enum SoeOriginStatusChange
    {
        None = 0,
    ...
    public enum SoeOriginStatusClassification
    {
        None = 0,
    ...
    public enum SoeOriginStatusClassificationGroup
    {
        None = 0,
    ...
    public enum SoePaymentStatusGroup
    {
        None = 0,
        GeneralStart = 1,
        GeneralStop = 10,
    ...
    public enum SoeTimeBlockDateStatus
    {
        None = 0,
        Regenerating = 1,
    ...
    public enum ExcelColumnAddress
    {
    ...
    public enum ExcelColumnPaymentInformation
    {
        StandardPaymentType = 1,
        BgNr = 2,
        PgNr = 3,
        BankNr = 4,
        [Obsolete("BicIbanNr is deprecated, use Bic and Iban instead", false)]
        BicIbanNr = 5,
        Bic = 6,
        Iban = 7,
    }

    public enum ExcelColumnCustomer
    {
        CustomerNr = 1,
        Name = 2,
        OrgNr = 3,
    ...
    public enum ExcelColumnSupplier
    {
        SupplierNr = 1,
        Name = 2,
        OrgNr = 3,
    ...
    public enum ExcelColumnContactPerson
    {
        FirstName = 1,
        LastName = 2,
        Position = 3,
    ...
    public enum ExcelColumnProduct
    {
        ProductNr = 1,
        Name = 2,
        Description = 3,
    ...
    public enum ExcelColumnEmployee
    {
        EmployeeId = 1,
    ...
    public enum ExcelColumnProductGroup
    {
        Code = 0,
        Name = 1,
    }

    public enum ExcelColumnCustomeCategory
    {
        Code = 0,
        Name = 1,
    }

    public enum ExcelColumnPayrollStartValue
    {
        Code = 1,
        Appellation = 2,
        EmployeeNr = 3,
    ...
    public enum ExcelColumnAccount
    {
        AccountNr = 1,
        AccountName = 2,
        Description = 3,
    ...
    public enum ExcelColumnTaxDeductionContact
    {
        CustomerNr = 1,
        CustomerName = 2,
        SocialSeqNr = 3,
    ...
    public enum ExcelColumnPricelist
    {
        Name = 1,
        Description = 2,
        Currency = 3,
    ...
    public enum ExcelColumnAgreement
    {
        CustomerNr = 1,
        AgreementGroup = 2,
        InternalText = 3,
    ...
    #region External Company Search
    public enum ExternalCompanySearchProvider
    {
        None = 0,
        PRH = 1
    }
    ...
    public enum EmploymentAccountType
    {
        Unknown = 0,
    ...
    public enum EmployeeGroupAccountType
    {
        Unknown = 0,
        Cost = 1,   // Debit (Purchase)
        Income = 2, // Credit (Sales)
    ...
    public enum InventoryAccountType
    {
        Unknown = 0,
        Inventory = 1,
        AccWriteOff = 2,
    ...
    public enum PayrollGroupAccountType
    {
        Unknown = 0,
    ...
    public enum ProductAccountType
    {
        Unknown = 0,
        Purchase = 1,
        Sales = 2,
    ...
    public enum SoeInvoiceRowDiscountType
    {
        Unknown = 0,
        Percent = 1,
        Amount = 2,
    ...
    public enum SoeDayTypeClassification
    {
        Undefined = 0,
        Weekday = 1,
        Saturday = 2,
    ...
    public enum SoeTimeHalfdayType
    {
    ...
    public enum ContactAddressItemType
    {
        Unknown = 1,
    ...
    public enum TimeSchedulePlanningMonthDTOStatusType
    {
        Open = 1,
        Assigned = 2,
        Wanted = 3,
    ...
    #region Form/field settings

    public enum SoeSettingType
    {
        Field = 1,
        Form = 2,
    };

    public enum SoeSetting
    {
        Label = 1,
        Visible = 2,
        SkipTabStop = 3,
    ...
    public enum TextEntryValidation
    {
        ...
        //MinLength = 8,
        //Match = 16,
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Luhn")]
        Luhn = 32
    }

    public enum SoeFormIntervalEntryType
    {
        NoType = 0,
        Text = 1,
        Select = 2,
    ...
    #region Features and permissions
    ...
    public enum FeaturePermissionType
    {
        Unknown = 0,
        License = 1,
        Company = 2,
    ...
    public enum UnauthorizationType
    {
        None = 0,
    ...
    public enum RemoteLoginFailedType
    {
        None = 0,
        Failed = 1,
        NotAllowed = 2,
    ...
    public enum FontAwesomeIconSource
    {
        FontAwesome_Kit = 0,
        FontAwesome_CDN = 1,
        SoftOne_Embedded = 2
    ...
    public enum IntrastatReportingType
    {
        None = 0,
        Import = 1,
        Export = 2,
    ...
    public enum ImportPaymentIOStatus
    {
        None = 0,
        Match = 1,
        Rest = 2,
    ...
    public enum ImportPaymentIOState
    {
        Open = 0,
        Closed = 1,
        Deleted = 2
    ...
    public enum InExchangeStatusType
    {
        PendingInPlatform = 0,
        Sent = 1,
        Error = 2,
    ...
    public enum SoeInformationSourceType
    {
        Company = 1,    // Internal information
        Sys = 2         // Information from SoftOne
    }

    public enum SoeInformationType
    {
        Information = 1,
    }
    ...
    #region InputLoadType

    public enum InputLoadType
    {
        None = 0,
    ...
    #region InvoiceAttachmentSourceType

    public enum InvoiceAttachmentSourceType
    {
        None = 0,
        Edi = 1,
        DataStorage = 2,
    ...
    #region InvoiceAttachmentConnectType

    public enum InvoiceAttachmentConnectType
    {
        Manual = 0,
        Edi = 1,
        SupplierInvoice = 2,
    ...
    #region InvoiceRowInfoFlag
    [Flags]
    public enum InvoiceRowInfoFlag
    {
        None = 0,
        Info = 1,
        Error = 2,
    ...
    #region InvoiceTextType

    public enum InvoiceTextType
    {
        Unknown = 0,
    ...
    public enum LiquidityPlanningTransactionType
    {
        None = 0,
        IncomingBalance = 1,
        CustomerInvoice = 2,
    ...
    public enum MatrixFieldSetting
    {
        BackgroundColor = 1,
        FontColor = 2,
        BoldFont = 3,
    ...
    public enum TopMenuSelectorType
    {
        Role = 2,
        User = 3,
        Favorites = 4,
    ...
    #region MultiSelectDialog

    public enum MultiSelectDialogType
    {
        EmployeeGroup = 1,
        DayType = 2,
    ...
    #region OrderInvoiceRegistrationType

    public enum OrderInvoiceRegistrationType
    {
        Unknown = 0,
    ...
    public enum ProjectCentralBudgetRowType
    {
        Separator = 0,
    ...
    public enum ProjectCentralHeaderGroupType
    {
        None = 0,
        Time = 1,
        IncomeNotInvoiced = 2,
    ...
    public enum ProjectCentralStatusRowType
    {
        None = 0,
        TimeValueRow = 1,
        TimeSummaryRow = 2,
    ...
    #region ProductRowsContainers
    public enum ProductRowsContainers
    {
        Offer = 1,
        Order = 2,
        Invoice = 3,
    ...
    public enum PayrollStartValueUpdateType
    {
        None = 0,
        Insert = 1,
        OverWrite = 2,
    ...
    #region PersonalDataBatchType

    public enum PersonalDataBatchType
    {
        Unspecified = 0,
        Mobile = 1,
        ReportPdf = 2,
    ...
    public enum PurchaseCustomerInvoiceViewType
    {
        Unknown = 0,
        FromPurchase = 1,
    ...
    public enum ReadSoftPartiesType
    {
        Unknown = 0,
        Buyer = 1,
        Supplier = 2,
    ...
    public enum ScanningEntryRowType
    {
        Unknown = 0,
        IsCreditInvoice = 1,
        InvoiceNr = 2,
    ...
    public enum ScanningFeebackType
    {
        Other = 0,
        SupplierNotFound = 1,
    ...
    public enum SoeReportSortOrder
    {
        SeqNr = 1,
        ActorNr = 2,
        ActorName = 3,
    ...
    public enum SoeReportTemplateType
    {
    ...
    public enum SoeReportContentGroup
    {
        Category = 1,
        EmployeeGroup = 2,
    }
    public enum StatisticFileType
    {
        none = 0,
        SCB = 1,
        SN = 2,
    ...
    public enum SoeReportSettingField
    {
    ...
    public enum SoeReportSettingFieldType
    {
        Unknown = 0,
    ...
    public enum SoeReportSettingFieldMetaData
    {
        IsVisible = 1,
        DefaultValue = 2,
        ForceDefaultValue = 3,
    ...
    public enum ReportUserSelectionType
    {
        Unknown = 0,
        DataSelection = 1,
    ...
    #region ReconciliationRow

    public enum ReconciliationRowType
    {
        Voucher = 1,
        CustomerInvoice = 2,
        SupplierInvoice = 3,
    ...
    /// <summary>
    /// Type of recurrence.
    /// If recurrence is not used, set RecurrenceType = RunOnce.
    /// </summary>
    public enum ScheduledJobRecurrenceType
    {
    ...
    /// <summary>
    /// Specifies if job should retry to run if interrupted
    /// </summary>
    public enum ScheduledJobRetryType
    {
    ...
    /// <summary>
    /// The different states a scheduled job can be in.
    /// </summary>
    ...
    /// <summary>
    /// Type of SysJobSetting
    /// </summary>
    public enum SysJobSettingType
    {
        Unknown = 0,
        Job = 1,
        ScheduledJob = 2
    ...
    public enum ScheduledJobLogLevel
    {
        None = 0,
        Information = 1,
        Success = 2,
    ...
    #region ScheduleSwapLengthComparisonType

    public enum ScheduleSwapLengthComparisonType
    {
        Equal = 0,
        Shorter = 1,
        Longer = 2,
    ...
    public enum SignatoryContractAuthenticationMethodType
    {
        None = 0,
        Password = 1,
        PasswordSMSCode = 2,
    ...
    #region SoeAttestTreeMode

    public enum SoeAttestTreeMode
    {
        TimeAttest = 1,
    ...
    #region SoeAttestTreeLoadMode

    public enum SoeAttestTreeLoadMode
    {
        Full = 1,
        OnlyEmployees = 2,
    ...
    #region SoeAttestDeviceMode

    public enum SoeAttestDevice
    {
        Web = 1,
        Mobile = 2,
    }
    ...
    #region SoeTimeAttestWarning

    public enum SoeTimeAttestWarningGroup
    {
        Time = 0,
        Payroll = 1,
    }

    public enum SoeTimeAttestWarning
    {
        None = 0,
    ...
    public enum SoeTimeAttestInformation
    {
        None = 0,
        HasShiftSwaps = 1
    }
    ...
    #region SoeBillingInvoiceReportType

    public enum SoeBillingInvoiceReportType
    {
        Unknown = 0,
        Contract = 1,
        Offer = 2,
    ...
    #region SoeDataStorage


    public enum SoeDataStorageOriginType
    {
        Unknown = 0,
    ...
    public enum SoeDataStorageRecordType
    {
        Unknown = 0,
    ...
    #region SoeEmployeePostStatus

    public enum SoeEmployeePostStatus
    {
        None = 0,
        Locked = 1,
    ...
    #region SoeEmployeeTimePeriodStatus

    public enum SoeEmployeeTimePeriodStatus
    {
        None = 0,
        Open = 1,
        Paid = 2,
    ...
    #region SoeEmployeeTimePeriodValueType

    public enum SoeEmployeeTimePeriodValueType
    {
        None = 0,
        TableTax = 1,
        OneTimeTax = 2,
    ...
    #region SoeEmploymentFinalSalaryStatus

    public enum SoeEmploymentFinalSalaryStatus
    {
        None = 0,
        ApplyFinalSalary = 1,
    ...
    #region SoeEmploymentDateChangeType

    public enum SoeEmploymentDateChangeType
    {
        None = 0,
        Delete = 1,
        ShortenStart = 2,
    ...
    #region SoeVacationYearEndType

    public enum SoeVacationYearEndType
    {
        None = 0,
        VacationYearEnd = 1,
        FinalSalary = 2,
    ...
    #region SoeFavoriteOption

    public enum SoeFavoriteOption
    {
        //Manage 100-199
    ...
    #region SoeFieldSettingType

    public enum SoeFieldSettingType
    {
        Unknown = 0,
        Web = 1,
        Mobile = 2,
    ...
    #region SoeInvoiceMatchingType

    public enum SoeInvoiceMatchingType
    {
        Unknown = 0,
    ...
    #region SoeInvoiceInterestHandlingType

    public enum SoeInvoiceInterestHandlingType
    {
        NoInterest = 0,
        CreateNewInvoice = 1,
        AddToNextInvoice = 2,
    ...
    #region SoeInvoiceReminderHandlingType

    public enum SoeInvoiceReminderHandlingType
    {
        None = 0,
        CreateNewInvoice = 1,
        AddToNextInvoice = 2,
    ...
    #region SoeInvoiceToVoucherHeadType

    public enum SoeInvoiceToVoucherHeadType
    {
        None = 0,
        VoucherPerInvoice = 1,
    ...
    #region SoeInvoiceToVoucherRowType

    public enum SoeInvoiceToVoucherRowType
    {
        None = 0,
    ...
    #region SoeInvoiceExportStatusType

    public enum SoeInvoiceExportStatusType
    {
        NotExported = 0,
        ExportedAndClosed = 1,
        ExportedAndOpen = 2,
    ...
    #region SoeInvoiceImageStorageType
    public enum SoeInvoiceImageStorageType
    {
        NoImage = 0,
        StoredInEdiEntry = 1,
    ...
    #region SoeSupplierPaymentObservationMethod

    public enum SoeSupplierPaymentObservationMethod
    {
        None = 0,
        Observation = 1,
    ...
    #region SoeForeignPayments

    public enum SoeForeignPaymentBankCode
    {
        None = 0,
        Handelsbanken = 1,
        SEB = 2,
    ...
    public enum SoeForeignPaymentForm
    {
        None = 0,
        Account = 1,
        Check = 2,
    ...
    public enum SoeForeignPaymentMethod
    {
        None = 0,
        Normal = 1,
        Express = 2,
    ...
    public enum SoeForeignPaymentChargeCode
    {
        None = 0,
    ...
    public enum SoeForeignPaymentIntermediaryCode
    {
        None = 0,
        BGC = 1,
    };
    ...
    #region SoeLoginState

    public enum SoeLoginState
    {
        NotLoggedIn = 0,
        OK = 1,
        BadLogin = 2,
    ...
    public enum SoeSupportLoginState
    {
        NotLoggedIn = 0,
        OK = 1,
        NotAllowed = 2,
    ...
    #region SoeMobileType

    public enum SoeMobileType
    {
        Unknown = 0,
        XE = 1,
        Professional = 2,
    ...
    #region SoeMobileAppType

    public enum SoeMobileAppType
    {
        Unknown = 0,
        Personal = 1,
        Order = 2,
    ...
    #region SOEPayrollPriceFormula

    // Same values as in table SysPayrollPriceFormulaFixedValue
    public enum SoePayrollPriceFormulaFixedValue
    {
        Unknown = 0,
    ...
    #region SoePaymentExportStates

    public enum SoePaymentExportCancelledStates
    {
        Active = 0,
        PartyCancelled = 1,
        Cancelled = 2,
    ...
    public enum SoeProductPriceStatus
    {
        Undefined = 0,
        NewProduct = 1,
        NoPriceChange = 2,
    ...
    public enum SoeCompPriceListProvider
    {
        AhlsellVerktyg = 1,
        AhlsellBygg = 2,
        TBEl = 3,
    ...
    public enum SoeSysPriceListProvider
    {
        //EIO = 1,
        Sonepar = 2,
        AhlsellEl = 4,
    ...
    public enum SoeSysPriceListProviderType
    {
        Unknown = 0,
        Electrician = 1,
        Plumbing = 2,
    ...
    public enum SoeSupplierAgreementProvider
    {
        Ahlsell = 1,
        Dahl = 2,
        Sonepar = 3,
    ...
    public enum SoeSupplierAgreemntCodeType
    {
        MaterialCode = 1,
        Generic = 2,
        Product = 3,
    ...
    #region Wholeseller
    //Should match id in table SysWholeseller
    public enum SoeWholeseller
    {
        Unknown = 0,
        Sonepar = 1,
        Ahlsell = 2,
    ...
    #region SoeProgressInfoType

    public enum SoeProgressInfoType
    {
        Unknown = 0,
        Budget = 1,
    ...
    public enum SoeProjectRecordType
    {
        Invoice = 1,
        Order = 2,
        TimeSheet = 3,
    ...
    #region SoeRecalculateTimeHeadAction

    public enum SoeRecalculateTimeHeadAction
    {
        Placement = 1,
    }
    ...
    #region SoeReportDataOutputMessage

    public enum SoeReportDataResultMessage
    {
        Success = 0,
    ...
    #region SoeReportDataHistoryHeadTag

    public enum SoeReportDataHistoryHeadTag
    {
        //BillingInvoice
    ...
    #region SoeReportDataHistoryTag

    public enum SoeReportDataHistoryTag
    {
    ...
    // Duplicate: TermGroup_TimeRuleType
    public enum SoeTimeRuleType
    {
        Unknown = 0,
        Presence = 1,
        Absence = 2,
    ...
    public enum SoeTimeRuleOperatorType
    {
        Unspecified = 0,
    ...
    public enum SoeTimeRuleComparisonOperator
    {
        Unspecified = 0,
    ...
    // Duplicate: TermGroup_TimeRuleDirection
    public enum SoeTimeRuleDirection
    {
        Forward = 1,
        Backward = 2,
    }

    public enum SoeTimeRuleValueType
    {
        Undefined = 0,
    ...
    #region SoeTimeRuleGroup

    #endregion

    #endregion

    #region SoeStatesAnalysis

    public enum SoeStatesAnalysis
    {
        //General 1-20
        Role = 1,
        User = 2,
    ...
    #region SoeStatesAnalysisGroup
    public enum SoeStatesAnalysisGroup
    {
        General = 1,
        BillingAndLedger = 2,
        Edi = 3,
    ...
    #region SoeStatusIcon

    [Flags]
    public enum SoeStatusIcon
    {
        None = 0,
        Attachment = 1,
        Image = 2,
    ...
    #region SoeRecalculateAccountingMode

    public enum SoeRecalculateAccountingMode
    {
        FromShiftType = 1,
        FromSchedule = 2,
        FromTime = 3,
    ...
    #region SoeScheduleWorkRules

    public enum SoeScheduleWorkRules
    {
        None = 0,
        OverlappingShifts = 1,
    ...
    #region SoeStaffingNeedsTaskType

    public enum SoeStaffingNeedsTaskType
    {
        Unknown = 0,
        Task = 1,
        Delivery = 2,
    ...
    #region SoeStaffingNeedUnscheduledTasksType

    public enum SoeStaffingNeedType
    {
        Unknown = 0,
        EmployeePost = 1,
        Template = 2,
    ...
    #region SoeTabViewType

    public enum SoeTabViewType
    {
        Unknown = 0,
        Edit = 1,
        Setting = 2,
    ...
    #region SoeTimeAccumulatorComparison

    public enum SoeTimeAccumulatorComparison
    {
        OK = 0,
        LessThanMin = 1,
    ...
    #region SoeTimeAccumulatorBalanceType

    public enum SoeTimeAccumulatorBalanceType
    {
        Year = 1,
    };
    ...
    #region SoeTimeBlockDeviationChange

    public enum SoeTimeBlockDeviationChange
    {
        None = 0,
        Move = 1,
    ...
    #region SoeTimeBlockClientChange

    public enum SoeTimeBlockClientChange
    {
        None = 0,
        Left = 1,
        Right = 2,
    ...
    #region SoeTimeBreakTemplateType

    public enum SoeTimeBreakTemplateType
    {
        None = 0,
        Major = 1,
        Minor = 2,
    ...
    #region SoeTimeBreakTemplateEvaluation

    public enum SoeTimeBreakTemplateEvaluation
    {
        Test = 0,
        Automatic = 1,
        Manual = 2,
    ...
    #region SoeTimeScheduleEmployeePeriodDetailType

    public enum SoeTimeScheduleEmployeePeriodDetailType
    {
        Unknown = 0,
        LeisureCode = 1,
    }
    ...
    #region SoeTimeScheduleDeviationCauseStatus

    public enum SoeTimeScheduleDeviationCauseStatus
    {
        None = 0,
        Standard = 1,
        Planned = 2,
    ...
    #region SoeTimePayrollScheduleTransactionType

    public enum SoeTimePayrollScheduleTransactionType
    {
        None = 0,
        Schedule = 1,
        Absence = 2,
    ...
    #region SoeTimeBlockType

    public enum SoeTimeBlockType
    {
        Unknown = 0,
        Presence = 1,
        Absense = 2,
    ...
    #region SoeTimeBlockDateDetailType

    public enum SoeTimeBlockDateDetailType
    {
        Unknown = 0,
        Absence = 1,
    ...
    #region SoeTimeCodeType

    public enum SoeTimeCodeType
    {
    ...
    public enum SoeTimeCodeBreakTimeType
    {
        ScheduleIn = 1,
        ScheduleOut = 2,
    ...
    public enum SoeValidateDeviationChangeResultCode
    {
        Unknown = 0,
    ...
    public enum SoeValidateBreakChangeError
    {
        Unknown = 0,
        NoSchedule = 1,
        BreakNotFound = 2,
    ...
    #region SoeTimeEngineTask

    public enum SoeTimeEngineTask
    {
        Unknown = 0,
    ...
    public enum SoeTimeEngineTemplateType
    {
        None = 0,
    ...
    #region SoeTimeExport

    public enum SoeTimeSalaryExportTarget
    {
        Undefined = 0,
        SoeXe = 1,
        KontekLon = 2,
    ...
    public enum SoeTimeSalaryExportFormat
    {
        XML = 1,
        Text = 2,
        Zip = 3
    ...
    #region SoeTimeSalaryPaymentExport

    public enum SoeTimeSalaryPaymentExportFormat
    {
        Unknown = 0,
        XML = 1,
        Text = 2,
    ...
    #region SoeTimeAttestFunctionOption

    public enum SoeTimeAttestFunctionOption
    {
        RestoreToSchedule = 1,
    ...
    #region SoeTimePayrollCalculationOptions

    public enum SoeTimePayrollCalculationOption
    {
        RecalculatePeriod = 1,
        LockPeriod = 2,
        UnLockPeriod = 3,
    ...
    #region SoeTimeScheduledTimeSummaryType

    public enum TimeScheduledTimeSummaryType
    {
    ...
    #region SoeTimeScheduleTemplateBlockBreakType

    public enum SoeTimeScheduleTemplateBlockBreakType
    {
        None = 0,
        NormalBreak = 1,
    }
    ...
    #region SoeTimeScheduleTemplateBlockLendedType

    public enum SoeTimeScheduleTemplateBlockLendedType
    {
        None = 0,
        LendedToOther = 1,
        LendedInFromOther = 2,
    ...
    #region SoeTimeTransactionType

    public enum SoeTimeTransactionType
    {
        Unknown = 0,
        TimeCode = 1,
        TimePayroll = 2,
    ...
    #region SoeTimeModuleIcon

    public enum SoeModuleIconType
    {
        Unknown = 0,
        Personell = 7099,
        Schedule = 7100,
    ...
    #region SoeTimePeriodAccountValueType

    public enum SoeTimePeriodAccountValueType
    {
        Unknown = 0,
        Provision = 1,
    }

    public enum SoeTimePeriodAccountValueStatus
    {
        Open = 0,
        Locked = 1,
    }
    ...
    public enum SoeTimeWorkAccountYearOutcomeType
    {
        Selection = 0,
        AccAdjustment = 1,
    }

    #region SoeTimeUniqueDayEdit

    public enum SoeTimeUniqueDayEdit
    {
        Undefined = 0,
        AddHalfDay = 1,
        UpdateHalfDay = 2,
    ...
    #region SoeTranslationClient

    public enum SoeTranslationClient
    {
        GoogleTranslate = 1,
        BingTranslate = 2,
    }
    ...
    #region SoeSysLogRecordType

    public enum SoeSysLogRecordType
    {
        Unknown = 0,
        TimeTerminal = 1,
    }
    ...
    #region SoeVacationGroupDayType
    public enum SoeVacationGroupDayType
    {
        Undefined = 0,
    ...
    public enum StaffingNeedsHeadType
    {
        NeedsPlanning = 0,
        NeedsShifts = 1
    }

    public enum StaffingNeedsRowType
    {
        Normal = 0,
        ShiftTypeSummary = 1,
        TotalSummary = 2,
    ...
    public enum StaffingNeedsRowOriginType
    {
    ...
    #region SysExtraFieldType

    public enum SysExtraFieldType
    {
    ...
    #region SystemInfoSettings

    public enum SystemInfoLogLevel
    {
        None = 0,
        Information = 1,
        Warning = 2,
    ...
    #region SysWholesellerEdi

    /// <summary>
    /// This enum values corresponds to the syswholesellerediid found in the db.
    /// </summary>
    public enum SysWholesellerEdiIdEnum
    {
        Unknown = 0,
        Ahlsell = 1,
        Elektroskandia = 2,
    ...
    public enum SysLinkTableRecordType
    {
        Default = 0,  // Not set
        LinkSysReportTemplateToCountryId = 1,  // With the value 1, record is used to link sysreport into countrycode / Jukka
    }

    public enum SysLinkTableIntegerValueType  // Target field to ease remembering
    {
        Default = 0,  // Not set
    ...
    public enum TemplateDesignerComponent
    {
        TextBox = 1,
        TextArea = 2,
        CheckBox = 3,
    ...
    //2
    public enum TermGroup_AccountType
    {
        Asset = 1,
        Debt = 2,
        Income = 3,
    ...
    //3
    public enum TermGroup_YesNoDefault
    {
        No = 0,
        Yes = 1,
        Default = 2,
    ...
    //4
    public enum TermGroup_Languages
    {
        Unknown = 0,
        Swedish = 1,
        English = 2,
    ...
    //7
    public enum TermGroup_AmountStop
    {
        Debit = 1,
        Credit = 2,
    };
    ...
    //8
    public enum TermGroup_SysPaymentType
    {
        Unknown = 0,
        BG = 1,
        PG = 2,
    ...
    //9
    public enum TermGroup_SysContactEComType
    {
        Unknown = 0,
        Email = 1,
        PhoneHome = 2,
    ...
    //10
    public enum TermGroup_SysContactType
    {
        Undefined = 0,
        Company = 1,
        Employee = 2,
    ...
    //11
    public enum TermGroup_SysContactAddressType
    {
        Undefined = 0,
        Distribution = 1,
        Visiting = 2,
    ...
    //12
    public enum TermGroup_SysContactAddressRowType
    {
        Unknown = 0,
        Address = 1,
        AddressCO = 2,
    ...
    //13
    public enum TermGroup_AccountStatus
    {
        New = 1,
        Open = 2,
        Closed = 3,
    ...
    //14
    public enum TermGroup_SieAccountDim
    {
        CostCentre = 1,
        CostUnit = 2,
        Project = 6,
    ...
    //17
    public enum TermGroup_ReportExportType
    {
        Unknown = 0,
        Pdf = 1,
        Xml = 2,
    ...
    //21
    public enum TermGroup_VoucherRowHistorySortField
    {
        VoucherNr = 1,
        AccountNr = 2,
        RegDate = 3,
    ...
    //22
    public enum TermGroup_VoucherRowHistorySortOrder
    {
        Ascending = 1,
        Descending = 2,
    };
    ...
    //23
    public enum TermGroup_SysDayType
    {
        Unknown = 0,
        PublicHoliday = 1,
        Workday = 2,
    ...
    //26
    public enum TermGroup_Currency
    {
        SEK = 1,
        USD = 2,
        EUR = 3,
    ...
    //27
    public enum TermGroup_BillingType
    {
        None = 0,
        Debit = 1,
        Credit = 2,
    ...
    //28
    public enum TermGroup_InvoiceVatType
    {
        None = 0,
        Merchandise = 1,
        //Service = 2,
    ...
    public enum TermGroup_VatDeductionType
    {
        None = 0,
    };

    //29
    public enum TermGroup_SysPaymentMethod
    {
        None = 0,
        LB = 1,
        PG = 2,
    ...
    //37
    public enum TermGroup_ReportLedgerInvoiceSelection
    {
        All = 1,
        FullyPayed = 2,
        PartlyPayed = 3,
    ...
    //41
    public enum TermGroup_ReportLedgerDateRegard
    {
        InvoiceDate = 1,
        VoucherDate = 2,
        DueDate = 3,
    ...
    // 48
    public enum TermGroup_InvoiceProductVatType
    {
        None = 0,
        Merchandise = 1,
        Service = 2,
    ...
    //50
    public enum TermGroup_ReportBillingInvoiceSortOrder
    {
        InvoiceNr = 1,
        CustomerNr = 2,
        ProjectNr = 3,
    ...
    //51
    public enum TermGroup_ContactPersonPosition
    {
        Unknown = 0,
        Other = 1,
        Buyer = 2,
    ...
    //67
    public enum TermGroup_AttestEntity
    {
        Unknown = 0,
    ...
    // Not a TermGroup on its own, just grouping of TermGroup_AttestEntity
    public enum TermGroup_AttestEntityGroup
    {
        EconomyStart = 1,
        EconomyStop = 10,
        BillingStart = 11,
    ...
    //69
    public enum TermGroup_TimePeriodType
    {
        Unknown = 0,
        Billing = 1,
        Payroll = 2,
    ...
    //81
    public enum TermGroup_PayrollType
    {
        Unknown = 0,
        Work = 1,
        Absence = 2,
    ...
    // 82
    public enum TermGroup_CompanyPayrollProductAccountingPrio
    {
        NotUsed = 0,
        Project = 1,
        Customer = 2,
    ...
    // 83
    public enum TermGroup_CompanyInvoiceProductAccountingPrio
    {
        NotUsed = 0,
        Project = 1,
        Customer = 2,
    ...
    // 84
    public enum TermGroup_EmployeeGroupPayrollProductAccountingPrio
    {
        NotUsed = 0,
        Project = 1,
        Customer = 2,
    ...
    // 85
    public enum TermGroup_EmployeeGroupInvoiceProductAccountingPrio
    {
        NotUsed = 0,
        Project = 1,
        Customer = 2,
    ...
    // 86
    public enum TermGroup_TimeProjectPayrollProductAccountingPrio
    {
        NotUsed = 0,
        Project = 1,
        Customer = 2,
    ...
    // 87
    public enum TermGroup_TimeProjectInvoiceProductAccountingPrio
    {
        NotUsed = 0,
        Project = 1,
        Customer = 2,
    ...
    // 88
    public enum TermGroup_PayrollProductAccountingPrio
    {
        NotUsed = 0,
        NoAccounting = 1,
        Project = 2,
    ...
    // 89
    public enum TermGroup_InvoiceProductAccountingPrio
    {
        NotUsed = 0,
        NoAccounting = 1,
        Project = 2,
    ...
    //93
    public enum TermGroup_MergeInvoiceProductRows
    {
        Never = 1,
        Ask = 2,
        Always = 3,
    ...
    //94
    public enum TermGroup_TimeDeviationCauseType
    {
        Undefined = 0,
        Absence = 1,
        Presence = 2,
    ...
    //95
    public enum TermGroup_TimeCodeRoundingType
    {
        None = 0,
        RoundUp = 1,
        RoundDown = 2,
    ...
    // 103
    public enum TermGroup_ScheduledJobLogLevel
    {
        None = 0,
        Information = 1,
        Success = 2,
    ...
    //104
    public enum TermGroup_AccumulatorTimePeriodType
    {
        Unknown = 0,
        Day = 1,
        Week = 2,
    ...
    //107
    public enum TermGroup_InitProductSearch
    {
        Automatic = 1,
        WithEnter = 2
    }
    ...
    //114
    public enum TermGroup_EDIOrderStatus
    {
        Unprocessed = 1,
        UnderProcessing = 2,
        Processed = 3,
    ...
    //115
    public enum TermGroup_EDIInvoiceStatus
    {
        Unprocessed = 1,
        UnderProcessing = 2,
        Processed = 3,
    ...
    //116
    public enum TermGroup_EDISourceType
    {
        Unset = 0,
        EDI = 1,
        Scanning = 2,
    ...
    //118
    public enum TermGroup_EDIStatus
    {
        Unprocessed = 1,
        UnderProcessing = 2,
        Processed = 3,
    ...
    //120
    public enum TermGroup_StandardDayOfWeek
    {
        Sunday = 0,
        Monday = 1,
        Tuesday = 2,
    ...
    //124
    public enum TermGroup_TimePeriodDeviationViewMode
    {
        Attest = 1,
        Schedule = 2,
        Restore = 3,
    ...
    //126
    public enum TermGroup_CustomerInvoiceOriginateFrom
    {
        Nothing = 0,
        Offer = 1,
        Order = 2,
    ...
    //127
    public enum TermGroup_ContractGroupPeriod
    {
        Week = 1,
        Month = 2,
        Quarter = 3,
    ...
    //128
    public enum TermGroup_ContractGroupPriceManagement
    {
        Fixed = 1,
    ...
    // 131
    public enum TermGroup_CheckSettingsArea
    {
    ...
    // 132
    public enum TermGroup_CheckSettingsResultType
    {
        NotChecked = 0,
        Passed = 1,
        Warning = 2,
    ...
    // 134
    public enum TermGroup_AttestRuleRowLeftValueType
    {
        None = 0,                       // Ingen vald
    ...
    // 135
    public enum TermGroup_AttestRuleRowRightValueType
    {
        None = 0,                       // Ingen vald
        PresenceTime = 1,               // Närvarotid
        ScheduledTime = 2,              // Schematid
    ...
    // 141
    public enum TermGroup_AccountDistributionTriggerType
    {
        None = 0,
        Registration = 1,
        Distribution = 2,
    ...
    // 142
    public enum TermGroup_AccountDistributionCalculationType
    {
        Percent = 1,
        Amount = 2,
    ...
    public enum TermGroup_AccountDistributionRegistrationType
    {
        None = 0,
        SupplierInvoice = 1,
        CustomerInvoice = 2,
    ...
    // 143
    public enum TermGroup_ScanningStatus
    {
        Unprocessed = 1,
        Interpreted = 2,
        Processed = 3,
    ...
    //144
    public enum TermGroup_ScanningMessageType
    {
        Unknown = 0,
        Arrival = 1,
        SupplierInvoice = 2,
    ...
    // 145
    public enum TermGroup_AccountDistributionPeriodType
    {
        Unknown = 0,
        Period = 1,
        Year = 2,
    ...
    // 148
    public enum TermGroup_ScanningInterpretation
    {
        ValueIsValid = 0,
        ValueIsUnsettled = 1,
        ValueNotFound = 2,
    ...
    // 149
    public enum TermGroup_InventoryWriteOffMethodType
    {
        Immediate = 1,
    ...
    // 150
    public enum TermGroup_InventoryWriteOffMethodPeriodType
    {
        Period = 1,
        Year = 2
    }
    ...
    // 151
    public enum TermGroup_InventoryStatus
    {
        None = 0,
    ...
    // 152 (See also SoeAccountDistributionType)
    public enum TermGroup_InventoryLogType
    {
        Purchase = 1,       // Inköp
    ...
    // 165 (Duplicate: SoeTimeRuleType)
    public enum TermGroup_TimeRuleType
    {
        Presence = 1,
        Absence = 2,
        Constant = 3,
    ...
    // 166 (Duplicate: SoeTimeRuleDirection)
    public enum TermGroup_TimeRuleDirection
    {
        Forward = 1,
        Backward = 2,
    }
    ...
    // 167
    public enum TermGroup_TimeAbsenceRuleType
    {
        None = 0,
    ...
    // 169
    public enum TermGroup_TimeAbsenceRuleRowType
    {
        Unknown = 0,
    ...
    // 171 (Duplicate: TimeStampEntryType)
    public enum TermGroup_TimeStampEntryType
    {
        Unknown = 0,
        In = 1,
        Out = 2
    ...
    // 173
    public enum TermGroup_TimeBlockDateStampingStatus
    {
        NoStamps = 0,
        Complete = 1,
        FirstStampIsNotIn = 2,
    ...
    // 179
    public enum TermGroup_TimeScheduleSyncBatchType
    {
    ...
    // 180
    public enum TermGroup_TimeScheduleSyncBatchStatus
    {
        Initialized = 0,
        FetchingSchedules = 1,
    ...
    // 181
    public enum TermGroup_TimeScheduleSyncEntryStatus
    {
        Stored = 0,
        CreatingSchedule = 1,
    ...
    // 183
    public enum TermGroup_EdiMessageType
    {
        Unknown = 0,
        SupplierInvoice = 1,
    ...
    // 188
    public enum TermGroup_SysMediaType
    {
    ...
    // 189
    public enum TermGroup_MediaType
    {
        Unspecified = 0,    // Used in queries
        Video = 1,
        Image = 2,
    ...
    // 190
    public enum TermGroup_MediaFormat
    {
        Unspecified = 0,    // Used in queries
        VideoWMV = 11,
        VideoMP4 = 12,
    ...
    // 194
    public enum TermGroup_TimeScheduleSyncLeaveApplicationStatus
    {
        Stored = 0,
        CreatingAbsence = 1,
    ...
    //195
    public enum TermGroup_CloseEdiEntryCondition
    {
        HandledManually = 0,
    ...
    // 198
    public enum TermGroup_TimeScheduleSyncEntryType
    {
        Unknown = 0,
        Presence = 1,
        Absence = 2,
    ...
    // 200
    public enum TermGroup_TimeCodeRegistrationType
    {
        Unknown = 0,
        Time = 1,
        Quantity = 2,
    ...
    // 202
    public enum TermGroup_TimeScheduleTemplateBlockShiftStatus
    {
        Open = 0,       // Ledigt pass
    ...
    // 203
    public enum TermGroup_TimeScheduleTemplateBlockShiftUserStatus
    {
    ...
    // 204
    public enum TermGroup_TimeScheduleTemplateBlockQueueType
    {
        Unspecified = 0,    // Used in queries
    ...
    //208
    public enum TermGroup_EmployeeRequestType
    {
        Undefined = 0,
        AbsenceRequest = 1,
        InterestRequest = 2,
    ...
    [Flags]
    public enum TermGroup_EmployeeRequestTypeFlags
    {
        Undefined = 0,
        AbsenceRequest = 1,
        InterestRequest = 2,
    ...
    //209
    public enum TermGroup_EmployeeRequestStatus
    {
        None = 0,
        RequestPending = 1,
        Preliminary = 2,
    ...
    // 212
    public enum TermGroup_MessageType
    {
        None = 0,
        UserInitiated = 1,
        ShiftRequest = 2,
    ...
    // 213
    public enum TermGroup_MessagePriority
    {
        None = 0,
        Low = 1,
        Normal = 2,
    ...
    // 214
    public enum TermGroup_MessageDeliveryType
    {
        XEmail = 1,
        Email = 2,
        SMS = 3
    ...
    // 215
    public enum TermGroup_MessageTextType
    {
        XAML = 1,
        HTML = 2,
        RTF = 3,
    ...
    // 218
    public enum TermGroup_TimeSchedulePlanningViews
    {
        Calendar = 0,
        Day = 1,
        Schedule = 2,
    ...
    // 219
    public enum TermGroup_TimeSchedulePlanningVisibleDays
    {
        Custom = 0,
        Day = 1,
        WorkWeek = 5,
    ...
    // 230
    public enum TermGroup_InvoiceProductCalculationType
    {
        Regular = 0,
        SupplementCharge = 1,
        FixedPrice = 2,
    ...
    //234
    public enum TermGroup_TimeAccumulatorType
    {
        Rolling = 1,
        PerYear = 2,
    };
    ...
    //242
    public enum TermGroup_EDIPriceSettingRule
    {
        UsePriceRules = 0,
    ...
    //250
    public enum TermGroup_ChecklistHeadType
    {
        Unknown = 0,
        Order = 1,
    }
    ...
    //253
    //if new type is added, se how datatypeid on checklistrow is set
    public enum TermGroup_ChecklistRowType
    {
        Unknown = 0,
        String = 1,
        YesNo = 2,
    ...
    //259
    public enum TermGroup_CurrencySource
    {
        None = 0,
        Manually = 1,
        Daily = 2,
    ...
    //260
    public enum TermGroup_CurrencyIntervalType
    {
        None = 0,
        Manually = 1,
        FirstDayOfQuarter = 2,
    ...
    // 263
    public enum TermGroup_CurrencyType
    {
        BaseCurrency = 1,
    ...
    // 267
    public enum TermGroup_MobileFields
    {
        //OrderEdit
    ...
    // 268
    public enum TermGroup_MobileForms
    {
        OrderEdit = 1,
        OrderGrid = 2,
        CustomerEdit = 3,
    ...
    // 275
    public enum TermGroup_IOStatus
    {
        Unprocessed = 1,
        UnderProcessing = 2,
        Processed = 3,
    ...
    // 277
    public enum TermGroup_IOSource
    {
        Unknown = 0,
        XE = 1,
        TilTid = 2,
    ...
    // 280
    public enum TermGroup_SysExportDefinitionType
    {
        XML = 0,
        Separator = 1,
        Fixed = 2
    ...
    // 281
    public enum TermGroup_SysImportDefinitionType
    {
        XML = 0,
        Separator = 1,
        Fixed = 2
    ...
    // 283
    public enum TermGroup_AttestFlowRowState
    {
    ...
    // 284
    public enum TermGroup_AttestWorkFlowType
    {
    ...
    // 285
    public enum TermGroup_InvoiceClaimLevel
    {
        None = 0,
        Claim1 = 1,
        Claim2 = 2,
    ...
    // 287
    public enum TermGroup_ProjectStatus
    {
        Unknown = 0,
        Planned = 1,
        Active = 2,
    ...
    // 288
    public enum TermGroup_ProjectUserType
    {
        Unknown = 0,
        Manager = 1,
        Participant = 2,
    ...
    // 292
    public enum TermGroup_ShiftHistoryType
    {
        Unknown = 0,
    ...
    //293
    public enum TermGroup_ProjectType
    {
        Unknown = 0,
        TimeProject = 1,
        CaseProject = 2,
    ...
    // 298
    public enum TermGroup_AttestWorkFlowRowProcessType
    {
        Unknown = 0,
        Registered = 1,
        WaitingForProcess = 2,
    ...
    //301
    public enum TermGroup_SysNewsDisplayType
    {
        News = 1,
        Popup = 2,
        NewsAndPopup = 3,
    ...
    // 308
    public enum TermGroup_ProjectAllocationType
    {
        Unknown = 0,
        External = 1,
        Internal = 2,
    ...
    //310
    public enum SysImportDefinitionUpdateType
    {
        None = 0,
        Always = 1,
        OnlyNew = 2,
    ...
    // 311
    public enum TermGroup_ProductSearchFilterMode
    {
        StartsWidth = 0,
        Contains = 1,
        Equals = 2
    ...
    // 316
    public enum TermGroup_IOImportHeadType
    {
        Unknown = 0,
        Supplier = 1,
        SupplierInvoice = 2,
    ...
    public enum IOImportSideDictionaryType
    {
        Unkown = 0,
        VatCodes = 1,
        PaymentConditions = 2,
    ...
    // 319
    public enum TermGroup_TimeStampAttendanceGaugeShowMode
    {
        AllLast24Hours = 0,
        AllToday = 1
    }
    ...
    // 322
    public enum TermGroup_StaffingNeedsAnalysisRefType
    {
    ...
    // 323
    public enum TermGroup_StaffingNeedsAnalysisDateComparer
    {
        None = 0,
    ...
    // 324
    public enum TermGroup_CompanyEdiType
    {
        Unknown = 0,
        Symbrio = 1,
        Nelfo = 2,
    ...
    // 326
    public enum TermGroup_StaffingNeedsAnalysisChartType
    {
        NeedAsLine = 1,
        NeedAsBar = 2,
    }
    ...
    // 330
    public enum TermGroup_CaseProjectResult
    {
        None = 0,
    ...
    // 331
    public enum TermGroup_CaseProjectPriority
    {
        Unknown = 0,
        Urgent = 1,
        High = 2,
    ...
    // 332
    public enum TermGroup_CaseProjectType
    {
        Unknown = 0,
        Bug = 1,
        Question = 2,
    ...
    // 336
    public enum TermGroup_StaffingNeedsRuleUnit
    {
        Unknown = 0,
        ItemsPerMinute = 1,
    ...
    // 338
    public enum TermGroup_CaseProjectChannel
    {
        Unknown = 0,
        Internal = 1,
        XE = 2,
    ...
    // 339
    public enum TermGroup_CaseProjectArea
    {
        Unknown = 0,
        Economy = 1,
        Invoice = 2,
    ...
    // 340
    public enum TermGroup_CaseProjectApplication
    {
        Unknown = 0,
        XE = 1,
        Professional = 2,
    ...
    // 345
    public enum TermGroup_EmployeeRequestResultStatus
    {
        None = 0,
        PartlyGranted = 1,
        FullyGranted = 2,
    ...
    // 351 (See CompanySettingType EmploymentType)
    public enum TermGroup_EmploymentType
    {
        Unknown = 0,
    ...
    // 361
    public enum TermGroup_SysPayrollPrice
    {
        Unknown = 0,

        #region Type 1 = Values in SysPayrollPrice table
        ...
        #region Type 2 = Values in other tables (coded)
    ...
    // 365
    public enum TermGroup_TimeScheduleTemplateBlockType
    {
        Schedule = 0,
        Order = 1,
        Booking = 2,
    ...
    //370
    public enum TermGroup_AttestTreeGrouping
    {
        None = 0,
    ...
    //371
    public enum TermGroup_AttestTreeSorting
    {
        None = 0,
        EmployeeNr = 1,
        FirstName = 2,
    ...
    //372
    public enum TermGroup_EmployeeDisbursementMethod
    {
        Unknown = 0,
    ...
    // 373
    public enum TermGroup_StaffingNeedsHeadInterval
    {
        FifteenMinutes = 15,
        ThirtyMinutes = 30,
        SixtyMinutes = 60
    ...
    //375
    public enum TermGroup_StaffingNeedsHeadStatus
    {
        None = 0,
        Preliminary = 1,
        Definate = 2,
    ...
    //376
    public enum TermGroup_EmploymentChangeFieldType
    {
        //Information 1-100
        DateFrom = 1,
        DateTo = 2,
    ...
    // 377
    public enum TermGroup_TimeSchedulePlanningShiftStyle
    {
        Detailed = 0,
        ActualTime = 1,
    ...
    // 378
    public enum TermGroup_EmploymentChangeType
    {
        Unknown = 0,
        Information = 1,
        DataChange = 2,
    ...
    // 380
    public enum TermGroup_EmploymentEndReason
    {
        None = 0,
    ...
    // 383
    public enum TermGroup_SysPayrollPriceType
    {
    ...
    // 385
    public enum TermGroup_SysPayrollType
    {
        None = 0,
    ...
    // 387
    public enum TermGroup_SysPayrollPriceAmountType
    {
        Amount = 0,
        Percent = 1,
        Days = 2,
    ...
    // 390
    public enum TermGroup_PayrollReviewStatus
    {
        New = 0,
        Preliminary = 1,
        Executed = 2
    ...
    // 393
    public enum TermGroup_PayrollProductCentRoundingType
    {
        None = 0,
        Mathematical = 1,
        Up = 2,
    ...
    // 394
    public enum TermGroup_PayrollProductTaxCalculationType
    {
        TableTax = 0,
        OneTimeTax = 1
    }
    ...
    // 396
    public enum TermGroup_EmployeeTaxType
    {
        NotSelected = 0,
    ...
    // 397
    public enum TermGroup_EmployeeTaxAdjustmentType
    {
        NotSelected = 0,
    ...
    // 398
    public enum TermGroup_EmployeeTaxSinkType
    {
        NotSelected = 0,
        Normal = 1,                 // SINK (25%)
    ...
    // 399
    public enum TermGroup_EmployeeTaxSalaryDistressAmountType
    {
        NotSelected = 0,
        FixedAmount = 1,
        AllSalary = 2,
    ...
    // 401
    public enum TermGroup_TrackChangesAction
    {
        Insert = 1,
        Update = 2,
        Delete = 3
    ...
    // 404
    public enum TermGroup_EmployeeTaxEmploymentTaxType
    {
        NotSelected = 0,
    ...
    // 406
    public enum TermGroup_PayrollResultType
    {
        None = 0,
        Time = 1,
        Quantity = 2,
    ...
    // 407
    public enum TermGroup_EmployeeTaxEmploymentAbroadCode
    {
        None = 0,
    ...
    // 408
    public enum TermGroup_VacationGroupType
    {
        Unknown = 0,
    ...
    // 409
    public enum TermGroup_PensionCompany
    {
        NotSelected = 0,
    ...
    // 420
    public enum TermGroup_StockTransactionType
    {
        Unknown = 0,
        Take = 1,
        Add = 2,
    ...
    // 421
    public enum TermGroup_ReportPrintoutDeliveryType
    {
        Unknown = 0,
        Instant = 1,
        Generate = 2,
    ...
    // 422
    public enum TermGroup_ReportPrintoutStatus
    {
        Unknown = 0,
        Ordered = 1,
        Delivered = 2,
    ...
    //423
    public enum TermGroup_EInvoiceDistributor
    {
        Unknown = 0,
        InExchange = 1,
        ReadSoft = 2,
    ...
    //424
    public enum TermGroup_EInvoiceFormat
    {
        Unknown = 0,
        Finvoice = 1,
        Svefaktura = 2,
    ...
    // 425
    public enum TermGroup_SysPerformanceMonitorTask
    {
        Unknown = 0,
    ...
    // 430
    public enum TermGroup_PayrollProductCentRoundingLevel
    {
        None = 0,
        Thousands = 1,
        Hundred = 2,
    ...
    //431
    public enum TermGroup_ReportExportFileType
    {
        Unknown = 0,
    ...
    // 432
    public enum TermGroup_PayrollProductTimeUnit
    {
        Hours = 0,
        WorkDays = 1,
        CalenderDays = 2,
    ...
    // 434
    public enum TermGroup_EmployeeStatisticsType
    {
    ...
    //435
    public enum TermGroup_ForeignPaymentBankCode
    {
        None = 0,
        Handelsbanken = 1,
        SEB = 2,
    ...
    //436
    public enum TermGroup_ForeignPaymentForm
    {
        None = 0,
        Account = 1,
        Check = 2,
    ...
    //437    
    public enum TermGroup_ForeignPaymentMethod
    {
        None = 0,
        Normal = 1,
        Express = 2,
    ...
    //438
    public enum TermGroup_ForeignPaymentChargeCode
    {
        None = 0,
        SenderDomesticCosts = 1,
        SenderAllCosts = 2,
    ...
    //439
    public enum TermGroup_ForeignPaymentIntermediaryCode
    {
        None = 0,
        BGC = 1,
    };
    ...
    //440
    public enum TermGroup_PayrollProductQuantityRoundingType
    {
        None = 0,
        Up = 1,
        Down = 2
    ...
    // 442
    public enum TermGroup_EmployeeStatisticsAverageType
    {
        None = 0,
        ShiftType = 1,
        Category = 2,
    ...
    // 447
    public enum TermGroup_VacationGroupCalculationType
    {
        Unknown = 0,
    ...
    // 448
    public enum TermGroup_VacationGroupRemainingDaysRule
    {
        Unknown = 0,
    ...
    // 449
    public enum TermGroup_PayrollExportPersonalCategory
    {
        Unknown = 0,
        Employee = 1,
        Others = 2,
    ...
    // 450
    public enum TermGroup_PayrollExportWorkTimeCategory
    {
        Unknown = 0,
        DayWork = 1,
        TwoShifts = 2,
    ...
    // 451
    public enum TermGroup_PayrollExportSalaryType
    {
        Unknown = 0,
        Monthly = 1,
        Weekly = 2,
    ...
    // 452
    public enum TermGroup_VacationGroupVacationDaysHandleRule
    {
        Unknown = 0,
    ...
    // 453
    public enum TermGroup_VacationGroupVacationSalaryPayoutRule
    {
        Unknown = 0,
    ...
    // 454
    public enum TermGroup_VacationGroupVacationAbsenceCalculationRule
    {
        Unknown = 0,
    ...
    // 455
    public enum TermGroup_VacationGroupGuaranteeAmountMaxNbrOfDaysRule
    {
        Unknown = 0,
        All = 1,        // Samtliga
    ...
    // 456
    public enum TermGroup_VacationGroupVacationHandleRule
    {
        Unknown = 0,
        Days = 1,       // Dagar
        Hours = 2,      // Timmar
    ...
    // 457
    public enum TermGroup_TimeSalaryPaymentExportType
    {
        Undefined = 0,
        SUS = 1, // Swedbank
    ...
    // 462
    public enum TermGroup_EmployeeFactorType
    {
    ...
    // 467
    public enum TermGroup_MassRegistrationInputType
    {
        Unknown = 0,
        Manual = 1,
        Automatic = 2,
    ...
    // 469
    public enum TermGroup_VoucherRowHistoryEvent
    {
        Unknown = 0,
        New = 1,
        Modified = 2,
    ...
    // 470 
    public enum TermGroup_VoucherRowHistoryField
    {
        Unknown = 0,
        VoucherDate = 1,
        VoucherText = 2,
    ...
    // 474
    public enum TermGroup_FollowUpTypeType
    {
        Own = 0,
    ...
    // 476
    public enum TermGroup_ChangeStatusGridAllItemsSelection
    {
        None = 0,
        One_Month = 1,
        Tree_Months = 3,
    ...
    // 478
    public enum TermGroup_SysPaymentService
    {
        Unknown = 0,
        Autogiro = 1,
    }
    ...
    //481
    public enum TermGroup_ReportGroupAndSortingTypes
    {
        //General
    ...
    //485
    public enum TermGroup_AccountMandatoryLevel
    {
        None = 0,
        Warn = 1,
        Mandatory = 2,
    ...
    // 487
    public enum TermGroup_VacationGroupYearEndRemainingDaysRule
    {
        Unknown = 0,
        Paid = 1,
        Saved = 2,
    ...
    // 488
    public enum TermGroup_VacationGroupYearEndOverdueDaysRule
    {
        Unknown = 0,
        Paid = 1,
        Saved = 2
    ...
    // 489
    public enum TermGroup_VacationGroupYearEndVacationVariableRule
    {
        Unknown = 0,
        Paid = 1,
        Saved = 2
    ...
    // 490
    public enum TermGroup_SoePayrollPriceType
    {
        Misc = 0,
        Hourly = 1,
        Monthly = 2,
    ...
    // 494
    public enum TermGroup_VehicleType
    {
        Unknown = 0,
        Car = 1,
        Lorry = 2,
    ...
    // 496
    public enum TermGroup_SysPayrollStartValue
    {
        //PJ specar
    }
    ...
    // 501
    public enum TermGroup_SysPageStatusSiteType
    {
        Test = 0,
        Beta = 1,
        Live = 2
    ...
    // 502
    public enum TermGroup_SysPageStatusStatusType
    {
        Blocked = 0,
        RFT = 1,
        Active = 2,
    ...
    // 505
    public enum TermGroup_SupplierInvoiceType
    {
        None = 0,
        Invoice = 1,
        Scanning = 2,
    ...
    // 506
    public enum TermGroup_AttestWorkFlowApproverType
    {
        User = 0,
        AttestRole = 1
    }
    ...
    // 507
    public enum TermGroup_AfaCategory
    {
        None = 0,
        Arbetare = 1,
        Tjansteman = 2,
    ...
    // 508
    public enum TermGroup_AfaSpecialAgreement
    {
        None = 0,
    ...
    // 509
    public enum TermGroup_PayrollReportsCollectumITPplan
    {
        None = 0,
        ITP1 = 1,
        ITP2 = 2,
    ...
    // 510
    public enum TermGroup_SupplierInvoiceAttestGroupSuggestionPrio
    {
        None = 0,
        Supplier = 1,
        Costplace = 2,
    ...
    // 511
    public enum TermGroup_OrderType
    {
        Unspecified = 0,
        Project = 1,
        Sales = 2,
    ...
    // 514
    public enum TermGroup_TimeSchedulePlanningDayViewGroupBy
    {
        Employee = 0,
        Category = 1,
        ShiftType = 2,
    ...
    // 515
    public enum TermGroup_TimeSchedulePlanningDayViewSortBy
    {
        Firstname = 0,
        Lastname = 1,
        EmployeeNr = 2,
    ...
    // 516
    public enum TermGroup_TimeSchedulePlanningScheduleViewGroupBy
    {
        Employee = 0,
        Category = 1,
        ShiftType = 2
    ...
    // 517
    public enum TermGroup_TimeSchedulePlanningScheduleViewSortBy
    {
        Firstname = 0,
        Lastname = 1,
        EmployeeNr = 2
    ...
    // 520
    public enum TermGroup_TimeSchedulePlanningEmployeeListSortBy
    {
        Firstname = 0,
        Lastname = 1,
        EmployeeNr = 2,
    ...
    // 521
    public enum TermGroup_StaffingNeedsDayViewGroupBy
    {
        None = 0,
        AccountDim2 = 1,
        AccountDim3 = 2,
    ...
    // 522
    public enum TermGroup_StaffingNeedsScheduleViewGroupBy
    {
        None = 0,
        AccountDim2 = 1,
        AccountDim3 = 2,
    ...
    // 523
    public enum TermGroup_StaffingNeedsDayViewSortBy
    {
        Name = 0,
        StartTime = 1,
    }
    ...
    // 524
    public enum TermGroup_DailyRecurrencePatternType
    {
        Daily = 0,              // Every day
        Weekly = 1,             // Every week
    ...
    // 525
    public enum TermGroup_DailyRecurrencePatternWeekIndex
    {
        First = 0,
        Second = 1,
        Third = 2,
    ...
    // 526
    public enum TermGroup_DailyRecurrenceRangeType
    {
        EndDate = 0,    // End by specific date
        NoEnd = 1,      // No end date
        Numbered = 2    // End after specific number of occurrences
    ...
    //527
    public enum TermGroup_AccountingBudgetSubType
    {
        Year = 0,
        January = 1,
        February = 2,
    ...
    //528
    public enum TermGroup_AccountingBudgetType
    {
        AccountingBudget = 1,
        StaffBudget = 2,
        ProjectBudget = 3,
    ...
    //531
    public enum TermGroup_SalesBudgetInterval
    {
        Year = 1,
        MontWeekly = 2,
        MonthDaily = 3,
    ...
    //532
    public enum TermGroup_StaffingNeedHeadsFilterType
    {
        None = 0,
        ActualNeed = 1,
        BaseNeed = 2,
    ...
    //533
    public enum TermGroup_EmployeePostWeekendType
    {
        AutomaticWeekend = 0,
    ...
    //535
    public enum TermGroup_SoeRetroactivePayrollStatus
    {
        Unknown = 0,
        Saved = 1,
        Multiple = 2,
    ...
    //536
    public enum TermGroup_SoeRetroactivePayrollEmployeeStatus
    {
        Unknown = 0,
        Saved = 1,
        Calculated = 11,
    ...
    //537
    public enum TermGroup_RetroactivePayrollAccountType
    {
        Unknown = 0,
    ...
    // 538
    public enum TermGroup_TimeSchedulePlanningFollowUpCalculationType
    {
        All = 0,
        Sales = 1,
        Hours = 2,
    ...
    // 539
    public enum TermGroup_SysVehicleFuelType
    {
        Unknown = 0,
        Gasoline = 1,       // Bensin
        Diesel = 2,         // Diesel
    ...
    // 540
    public enum TermGroup_EDistributionType
    {
        Unknown = 0,
        Email = 1,
        Inexchange = 2,
    ...
    // 541
    public enum TermGroup_EDistributionStatusType
    {
        PendingInPlatform = 0,
        Sent = 1,
        Error = 2,
    ...
    // 542
    public enum TermGroup_GridDateSelectionType
    {
        None = 0,
        One_Day = 1,
        One_Week = 7,
    ...
    // 543
    public enum TermGroup_SoeRetroactivePayrollOutcomeErrorCode
    {
        None = 0,
    ...
    // 545
    public enum TermGroup_TimeSchedulePlanningBreakVisibility
    {
        Hidden = 0,
        TotalMinutes = 1,
        Details = 2,
    ...
    // 546
    public enum TermGroup_TrackChangesColumnType
    {
        Unspecified = 0,
    ...
    public enum TermGroup_PersonalDataActionType
    {
        Unspecified = 0,
        Read = 1,
        Modify = 2,
    ...
    public enum TermGroup_PersonalDataInformationType
    {
        Unspecified = 0,
    ...
    public enum TermGroup_TrackChangesActionMethod
    {
        Unspecified = 0,
        CommonInsert = 1,
        CommonUpdate = 2,
    ...
    // 551
    public enum TermGroup_ScanningReferenceTargetField
    {
        Unspecified = 0,
        Costplace = 1,
        Project = 2,
    ...
    // 552
    public enum TermGroup_ScanningCodeTargetField
    {
        Unspecified = 0,
        OrderNumber = 1,
        BillingProject = 2,
    ...
    // 553
    public enum TermGroup_PersonalDataType
    {
        Unknown = 0,
        Employee = 1,
        ContactPerson = 2,
    ...
    // 554
    public enum TermGroup_OrderPlanningShiftInfo
    {
        NoInfo = 0,
        ShiftType = 1,
        CustomerName = 2,
    ...
    // 555
    public enum TermGroup_AssignmentTimeAdjustmentType
    {
        OneDay = 0,
    ...
    // 556
    public enum TermGroup_TemplateScheduleActivateFunctions
    {
        NewPlacement = 1,
        ChangeStopDate = 2
    }
    ...
    // 557
    public enum TermGroup_ExpenseType
    {
        Unknown = 0,
        Mileage = 1,
        AllowanceDomestic = 2,
    ...
    // 558
    public enum TermGroup_SysReportTemplateTypeGroup
    {
        None = 0,
        Employee = 1,
        Schedule = 2,
    ...
    // 559
    public enum TermGroup_TimeReportType
    {
        Stamp = 0,
        Deviation = 1,
        ERP = 2,
    ...
    // 560
    public enum TermGroup_QualifyingDayCalculationRule
    {
        UseWorkTimeWeek = 0,
    ...
    // 562
    public enum TermGroup_TimeSchedulePlanningFollowUpCalculateBy
    {
        Budget = 1,
        Forecast = 2
    }
    ...
    // 563
    public enum TermGroup_PerformanceTestInterval
    {
        All = 0,
        Hour = 1,
        Day = 2
    ...
    // 564
    public enum TermGroup_TaskWatchLogResultCalculationType
    {
        Total = 0,
        Record = 1
    }
    ...
    // 565
    public enum TermGroup_RecalculateTimeHeadStatus
    {
        Started = 0,
        Unprocessed = 1,
        UnderProcessing = 2,
    ...
    // 566
    public enum TermGroup_RecalculateTimeRecordStatus
    {
        Waiting = 0,
        Unprocessed = 1,
        UnderProcessing = 2,
    ...
    // 567
    public enum VoucherRowMergeType
    {
        DoNotMerge = 0,
        Merge = 1,
        MergeDebitCredit = 2,
    ...
    // 568
    public enum TermGroup_VoucherHeadSourceType
    {
        Unknown = 0,
        Payroll = 1,
        MergeDebitCredit = 2,
    ...
    // 569
    public enum TermGroup_InformationSeverity
    {
        Information = 1,
        Important = 2,
        Emergency = 3
    ...
    // 570
    public enum TermGroup_InformationStickyType
    {
    ...
    // 572
    public enum TermGroup_MassRegistrationImportType
    {
        Unknown = 0,
        Excel = 1,
        SoftOneClassic = 2,
    ...
    // 573
    public enum TermGroup_TimeScheduleScenarioHeadSourceType
    {
        Empty = 0,
        Schedule = 1,
        Template = 2,
    ...
    // 578
    public enum TermGroup_OrderEdiTransferMode
    {
        None = 0,
        Disable = 1,
        SetPricesToZero = 2,
    ...
    // 579
    public enum TermGroup_FileDisplaySortBy
    {
        Description = 1,
        Created = 2
    }
    ...
    //580
    public enum TermGroup_IncludeExpenseInReportType
    {
        None = 0,
        All = 1,
        OnlyInvoiced = 2,
    ...
    // 584
    public enum TermGroup_ApiMessageType
    {
        Unkown = 0,
        Employee = 1,
        ActiveSchedule = 2
    ...
    // 585
    public enum TermGroup_ApiMessageStatus
    {
        Unknown = 0,
        Initialized = 1,
        Processing = 2,
    ...
    // 586
    public enum TermGroup_ApiMessageChangeType
    {
        Unknown = 0,
        Employee = 1,
        Employment = 2,
	...
	// 588 PrognosType / Forecast interval
	public enum TermGroup_PrognoseInterval
	{
		None = 0,
		Month = 1,
		Quarter = 2,
	...
	//589
	public enum TermGroup_ApiMessageSourceType
    {
        API = 0,
        APIManual = 1,
    ...
    // 590
    public enum TermGroup_GoTimeStampIdentifyType
    {
        OnlyTag = 1,
    ...
    // 591
    public enum TermGroup_EventHistoryType
    {
        Unspecified = 0,
    ...
    // 592
    public enum TermGroup_AttestRoleUserAccountPermissionType
    {
        Complete = 0,
        Secondary = 1,
        ReadOnly = 2
    ...
    // 593
    public enum TermGroup_HouseHoldTaxDeductionType
    {
        None = 0,
        ROT = 1,
        RUT = 2,
    ...
    // 594
    public enum TermGroup_AdjustQuantityByBreakTime
    {
        None = 0,
        Add = 1,
        Remove = 2,
    ...
    // 595
    public enum TermGroup_MobileHouseHoldTaxDeductionType
    {
        None = 0,
        ROT = 1,
        RUT = 2,
    ...
    // 596
    public enum TermGroup_TimeIntervalPeriod
    {
        Day = 1,
        Week = 7,
        Month = 30,
    ...
    // 597
    public enum TermGroup_TimeIntervalStart
    {
        BeginningOfPeriod = 0,
        CurrentTime = 1
    }
    ...
    // 598
    public enum TermGroup_TimeIntervalStop
    {
        EndOfPeriod = 0,
        CurrentTime = 1
    }
    ...
    // 600
    public enum TermGroup_ScheduledJobLogStatus
    {
        Started = 1,
        Running = 2,
        Aborted = 3,
    ...
    // 601
    public enum TermGroup_AverageSalaryCostChartSeriesType
    {
        Men = 1,
        Women = 2,
        Total = 3,
    ...
    // 602
    public enum TermGroup_VacationBalance
    {
        None = 0,
    ...
    // 603
    public enum TermGroup_TimeStampEntryStatus
    {
    ...
    // 604
    public enum TermGroup_TimeStampEntryOriginType
    {
        Unknown = 0,
        AutoStampOutJob = 1,
        WebByEmployee = 10,
    ...
    //606
    public enum TermGroup_PayrollImportEmployeeScheduleStatus
    {
        Unprocessed = 0,
        Error = 1,
        Processed = 2,
    ...
    //607
    public enum TermGroup_PayrollImportEmployeeTransactionType
    {
        Unknown = 0,
        PayrollProduct = 1,
        SalaryAddition = 2,
    ...
    //608
    public enum TermGroup_PayrollImportEmployeeTransactionStatus
    {
        Unprocessed = 0,
        Error = 1,
        Processed = 2,
    ...
    //609
    public enum TermGroup_PayrollImportHeadType
    {
        Unknown = 0,
        File = 1,
        API = 2,
    ...
    //610
    public enum TermGroup_PayrollImportHeadFileType
    {
        Unknown = 0,
        SoftOneClassic = 1,
    ...
    // 611
    public enum TermGroup_VacationYearEndHeadContentType
    {
        VacationGroup = 0,
        Employee = 1,
    }
    ...
    // 611
    public enum TermGroup_CustomerSpecificExports
    {
        None = 0,
    ...
    // 613
    public enum TermGroup_TimeTransactionMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    // 614
    public enum TermGroup_PayrollTransactionMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    // 615
    public enum TermGroup_EmployeeListMatrixColumns
    {
        Unknown = 0,
        EmployeeId = 1,
        EmployeeNr = 10,
    ...
    // 616
    public enum TermGroup_CompanyExternalCodeEntity
    {
        Unknown = 0,
        Customer = 1,
        Supplier = 2,
    ...
    // 617
    public enum TermGroup_TimeTerminalAttendanceViewSortOrder
    {
        Name = 0,
        Time = 1
    }
    ...
    // 618
    public enum TermGroup_PayrollImportHeadStatus
    {
        Unprocessed = 0,
        Error = 1,
        Processed = 2,
    ...
    // 619
    public enum TermGroup_PayrollImportEmployeeStatus
    {
        Unprocessed = 0,
        Error = 1,
        Processed = 2,
    ...
    // 620
    public enum TermGroup_ScheduleTransactionMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    // 621
    public enum TermGroup_TimeCodeRuleType
    {
        Unknown = 0,
    ...
    // 622
    public enum TermGroup_EmployeeDateMatrixColumns
    {
        EmployeeNr = 1,
        EmployeeName = 2,
        Date = 3,
    ...
    // 623
    public enum TermGroup_TimeStampMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    // 624
    public enum TermGroup_EmployeeSelectionAccountingType
    {
        EmployeeCategory = 0,
        EmployeeAccount = 1,
    ...
    //626
    public enum TermGroup_TimeAccumulatorCompareModel
    {
        Unknown = 0,
        SelectedRange = 1,
        AccToday = 2,
    ...
    // 627
    public enum TermGroup_ReportUserSelectionAccessType
    {
        Private = 0,
        Public = 1,
        Role = 2,
    ...
    //628
    public enum TermGroup_PurchaseOrderSortOrder
    {
        PurchaseNr = 1,
        SupplierNr = 2
    }
    ...
    //759
    public enum TermGroup_PurchaseCartStatus
    {
        Open = 1,
        Transferred = 2,
        Closed = 3
    ...
    //769
    public enum TermGroup_PurchaseCartPriceStrategy
    {
        Unknown = 1,
    ...
    //760
    public enum TermGroup_InvoiceRowImportType
    {
        Excel = 1,
        Jcad = 2,
    }
    //761
    public enum TermGroup_TimeWorkReductionPeriodType
    {
        Week = 1,
    }

    //629
    public enum TermGroup_ApiSettingType
    {
        Uknown = 0,
    ...
    // 630
    public enum TermGroup_DataStorageRecordAttestStatus
    {
        None = 0,
        Initialized = 1,
        PartlySigned = 2,
    ...
    // 631
    public enum TermGroup_UserMatrixColumns
    {
        Unknown = 0,
        LoginName = 1,
        Name = 2,
    ...
    // 632
    public enum TermGroup_SupplierMatrixColumns
    {
        Unknown = 0,
        SupplierName = 1,
        SupplierNr = 2,
    ...
    // 633
    public enum TermGroup_InvoiceProductMatrixColumns
    {
        Unknown = 0,
        ProductNr = 1,
        ProductName = 2,
    ...
    //634
    public enum TermGroup_CustomerMatrixColumns
    {
        Unknown = 0,
        CustomerName = 1,
        CustomerOrgNr = 2,
    ...
    //636
    public enum TermGroup_StaffingneedsFrequencyMatrixColumns
    {
        Unknown = 0,
        AccountName = 1,
        AccountNumber = 2,
    ...
    //637
    public enum TermGroup_EmployeeSkillMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        Name = 2,
    ...
    //638
    public enum TermGroup_OrganisationHrMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        FirstName = 2,
    ...
    //639
    public enum TermGroup_ShiftTypeSkillMatrixColumns
    {
        Unknown = 0,
        ShiftTypeName = 1,
        ShiftType = 2,
    ...
    //640
    public enum TermGroup_TimeSalaryPaymentExportBank
    {
        Unknown = 0,
        Handelsbanken = 1,
        Danskebank = 2,
    ...
    //641
    public enum TermGroup_EmployeeEndReasonsMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    //642
    public enum TermGroup_EmployeeSalaryMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    // 643
    public enum TermGroup_InsightChartTypes
    {
        None = 0,
        Pie = 1,
        Doughnut = 2,
    ...
    // 644
    public enum TermGroup_EmployeeTimePeriodMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    // 645
    public enum TermGroup_StaffingStatisticsMatrixColumns
    {
        Unknown = 0,
        Date = 1,
        ScheduleSales = 20,
    ...
    // 646
    public enum TermGroup_AggregatedTimeStatisticsMatrixColumns
    {
        Unknown = 0,
        AccountDimName = 1,
        AccountNr = 2,
    ...
    // 647
    public enum TermGroup_FixedInsights
    {
        Custom = 1,
    ...
    // 648
    public enum TermGroup_EmployeeMeetingMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    // 649
    public enum TermGroup_MatrixGroupAggOption
    {
        Sum = 1,
        Min = 2,
        Max = 3,
    ...
    // 650
    public enum TermGroup_MatrixDateFormatOption
    {
        // Formats in comment are from momentjs (https://momentjs.com/docs/#/displaying/)
    ...
    //651
    public enum TermGroup_ScheduledTimeSummaryMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    //652
    public enum TermGroup_EmployeeExperienceMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    //653
    public enum TermGroup_EmployeeDocumentMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    //654
    public enum TermGroup_ImportDynamicFileType
    {
    ...
    //655
    public enum TermGroup_ExtraFieldType
    {
        FreeText = 1,
        Integer = 2,
        Decimal = 3,
    ...
    //656
    public enum TermGroup_EmployeeAccountMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    public enum TermGroup_TimeScheduleScenarioEmployeeStatus
    {
        None = 0,
        Initiated = 1,
        Error = 2,
    ...
    //659
    public enum TermGroup_TimeScheduleSwapRequestStatus
    {
        Initiated = 0,
        Done = 1,
    }
    ...
    //660
    public enum TermGroup_TimeScheduleSwapRequestRowStatus
    {
        Initiated = 0,
    ...
    // 661
    public enum TermGroup_GTPAgreementNumber
    {
        NotSelected = 0,
    ...
    // 662
    public enum TermGroup_ReportStatisticsMatrixColumns
    {
        Unknown = 0,
        ReportName = 1,
        SystemReportName = 2,
    ...
    //663
    public enum TermGroup_StockPurchaseGenerationOptions
    {
    ...
    //664
    public enum TermGroup_EmployeeTemplateGroupRowType
    {
        Unknown = 0,
        FirstName = 1,
        LastName = 2,
    ...
    // 665
    public enum TermGroup_SoftOneStatusResultMatrixColumns
    {
        Unknown = 0,
        Date = 1,
        Created = 2,
    ...
    // 666
    public enum TermGroup_SoftOneStatusUpTimeMatrixColumns
    {
        Unknown = 0,
    ...
    // 667
    public enum TermGroup_SoftOneStatusEventMatrixColumns
    {
        Unknown = 0,
        Prio = 1,
        Url = 2,
    ...
    //668
    public enum TermGroup_EmployeeFixedPayLinesMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    //669
    public enum TermGroup_TimeAbsenceRuleRowScope
    {
        Coherent = 0,
        Calendaryear = 1,
    }
    ...
    //670
    public enum TermGroup_PaymentTransferStatus
    {
        None = 0,
        PendingTransfer = 5,
        Transfered = 10,
    ...
    //671
    public enum TermGroup_EmploymentHistoryMatrixColumns
    {
        Unknown = 0,
        EmploymentNumber = 1,
        FirstName = 2,
    ...
    //672
    public enum TermGroup_PayrollProductsMatrixColumns
    {
        Unknown = 0,
        Number = 1,
        Name = 2,
    ...
    //673
    public enum TermGroup_EmployeeSalaryDistressMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        Name = 2,
    ...
    //674
    public enum TermGroup_OrderAnalysisMatrixColumns
    {
        Unknown = 0,
        CustomerNumber = 1,
        CustomerName = 2,
    ...
    //676
    public enum TermGroup_EmployeeSalaryUnionFeesMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        Name = 2,
    ...
    //677
    public enum TermGroup_EmploymentDaysMatrixColumns
    {
        Unknown = 0,
        EmploymentNumber = 1,
        Name = 2,
    ...
    //678
    public enum TermGroup_TimeWorkAccountWithdrawalMethod
    {
        NotChoosed = 0,
        PensionDeposit = 1,
        PaidLeave = 2,
    ...
    //679
    public enum TermGroup_TimeWorkAccountYearEmployeeStatus
    {
        NotCalculated = 0,
        Created = 1,
        Calculated = 2,
    ...
    // 680
    public enum TermGroup_EmployeeTemplateGroupType
    {
        Normal = 0,
        SubstituteShifts = 1
    }
    ...
    //681
    public enum TermGroup_SalaryExportUseSocSecFormat
    {
        KeepEmployeeNr = 0,
    ...
    //682
    public enum TermGroup_InvoiceAnalysisMatrixColumns
    {
        Unknown = 0,
        CustomerNumber = 1,
        CustomerName = 2,
    ...
    public enum TermGroup_AccountHierarchyMatrixColumns
    {
        Unknown = 0,
        AccountNames = 1,
        AccountNumbers = 2,
    ...
    // 683
    public enum TermGroup_ScheduledJobSettingType
    {
        Unknown = 0,
    ...
    // 684
    public enum TermGroup_BridgeJobType
    {
        Unknown = 0,
    ...
    // 687
    public enum TermGroup_TimeSchedulePlanningShiftTypePosition
    {
        Left = 0,
        Center = 1
    }
    ...
    // 688
    public enum TermGroup_TimeSchedulePlanningTimePosition
    {
        Left = 0,
        ShiftEdges = 1,
        DayEdges = 2,
    ...
    // 689
    public enum TermGroup_MonthlyWorkTimeCalculationType
    {
        Divisor = 0,
    ...
    // 691
    public enum TermGroup_ControlEmployeeSchedulePlacementType
    {
    ...
    public enum TermGroup_ScheduleJobEventActivationType
    {
        Unknown = 0,
        EmployeeCreated = 101,
    ...
    // 692
    public enum TermGroup_IFPaymentCode
    {
        Unknown = 0,
        PayedFee = 1,
        LeaveOfAbsence = 3,
    ...
    // 693
    public enum TermGroup_UnionFeeAssociation
    {
        Other = 0,
        IFMetall = 1,
        SEF = 2,
    ...
    // 694
    public enum TermGroup_PayrollProductReportSettingType
    {
        Unknown = 0,
        Field = 1,
    ...
    // 695
    public enum TermGroup_AnnualProgressMatrixColumns
    {
        Unknown = 0,
        Date = 1,
    ...
    // 696
    public enum TermGroup_BridgeJobFileType
    {
        Unknown = 0,
    ...
    // 697
    public enum TermGroup_LongtermAbsenceMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        Name = 2,
    ...
    // 698
    public enum TermGroup_VacationBalanceMatrixColumns
    {
        Unknown = 0,
        EmploymentNr = 1,
        Name = 2,
    ...
    // 699
    public enum TermGroup_TimeWorkAccountYearResultCode
    {
        Succeeded = 0,
        Deleted = 2,
    ...
    // 700
    public enum TermGroup_SkandiaPensionType
    {
        Unknown = 0,
        AKAP_KR = 1,
    }
    ...
    // 701
    public enum TermGroup_SkandiaPensionCategory
    {
        Unknown = 0,
        AB_MÅNADSAVLÖNAD = 1,
    ...
    // 702
    public enum TermGroup_SkandiaPensionReportType
    {
        Unknown = 0,
    ...
    // 703
    public enum TermGroup_TimeWorkAccountYearSendMailCode
    {
        Succeeded = 0,
        SendFailed = 1,
        EmployeeNotFound = 2,
    ...
    // 704
    public enum TermGroup_TimeWorkAccountTransactionActionCode
    {
        CreateSucess = 0,
        DeleteSuccess = 2,
        BalanceSuccess = 3,
    ...
    //  705
    public enum TermGroup_ShiftQueueMatrixColumns
    {
        EmployeeId = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    // 706
    public enum TermGroup_ShiftHistoryMatrixColumns
    {
        EmployeeId = 0,
    ...
    // 707
    public enum TermGroup_ShiftRequestMatrixColumns
    {
        EmployeeId = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    // 708
    public enum TermGroup_AbsenceRequestMatrixColumns
    {
        EmployeeId = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    //709
    public enum TermGroup_TimeScheduleTemplateBlockQueueStatus
    {
        Active = 0, // (I kön)
    ...
    //710
    public enum TermGroup_SEFPaymentCode
    {
        Unknown = 0,
        PayedFee = 1,
        SickLeave = 4,
    ...
    // 711
    public enum TermGroup_EmployeeSettingType
    {
        None = 0,
    ...
    public enum TermGroup_ReportBillingDateRegard
    {
        OrderDate = 1,
        DeliveryDate = 2,
    }
    ...
    public enum TermGroup_VismaPayrollChangesMatrixColumns
    {
        Unknown = 0,
        Time = 1,
    ...
    // 714
    public enum TermGroup_TimeStampHistoryMatrixColumns
    {
        Unknown = 0,
        EntityText = 1,
        ColumnName = 2,
    ...
    // 715
    public enum TermGroup_BrandingCompanies
    {
        SoftOne = 0,
        FlexiblaKontoret = 1,
    }
    ...
    //717
    public enum TermGroup_VacationYearEndStatus
    {
        Ongoing = -1,
        Succeded = 0,
        Failed = 1,
    ...
    // 718
    public enum TermGroup_VerticalTimeTrackerMatrixColumns
    {
        Date = 1,
        StartDate = 2,
        EndDate = 3,
    ...
    // 719
    public enum TermGroup_HorizontalTimeTrackerMatrixColumns
    {
        Date = 1,
        StartDate = 2,
        EndDate = 3,
    ...
    // 720
    public enum TermGroup_LicenseInformationMatrixColumns
    {
        Database = 1,
        LicenseNr = 2,
        LicenseName = 3,
    ...
    // 721
    public enum TermGroup_ReportSettingType
    {
    ...
    /// Year -> V
    /// </summary>
    public enum TermGroup_FinnishTaxReturnExportTaxPeriodLength
    {
        Month = 1,      //K
        Quarter = 2,    //Q
        Year = 3,       //V
    ...
    // 724
    public enum TermGroup_AccountYearStatus
    {
        NotStarted = 1,
        Open = 2,
        Closed = 3,
    ...
    // 725
    public enum TermGroup_PayrollControlFunctionType
    {
        None = 0,
        TaxMissing = 1,
    ...
    // 726
    public enum TermGroup_PayrollControlFunctionStatus
    {
        Opened = 1,
        HideforPeriod = 2,
        Attention = 3,
    ...
    // 727
    public enum TermGroup_PayrollControlFunctionOutcomeChangeType
    {
        Manual = 1,
        Automatic = 2,
    }
    ...
    // 728
    public enum TermGroup_PayrollControlFunctionOutcomeChangeFieldType
    {
        Status = 1,
        Comment = 2,
        State = 3,
    ...
    //729
    public enum TermGroup_GrossMarginCalculationType
    {
        Unknown = 0,
        PurchasePrice = 1,
        StockAveragePrice = 2,
    ...
    //730
    public enum TermGroup_DatePeriodSelection
    {
        Today = 1,
        Yesterday = 2,
        CurrentWeek = 3,
    ...
    //731
    public enum TermGroup_ISOPaymentAccountType
    {
        Unknown = 0,
        BGNR = 1,
        BBAN = 2,
    ...
    // 732
    public enum TermGroup_TimeLeisureCodeSettingType
    {
        LeisureHours = 1,
        ScheduleType = 2,
        PreferredWeekDay = 3,
    ...
    // 733
    public enum TermGroup_TimeLeisureCodeType
    {
        None = 0,
        V = 1, // Weekly rest day
        X = 2, // Extra rest day
    ...
    // 734
    public enum TermGroup_TimeTreeWarningFilter
    {
        None = 0,
        Any = 1,
        Time = 2,
    ...
    // 735
    public enum TermGroup_SpecifiedType
    {
        None = 0,
    ...
    // 737
    public enum TermGroup_ChainAffiliation
    {
        None = 0,
        Bad_Varme = 1,
        Comfort = 2,
    ...
    // 738
    public enum TermGroup_ExtraFieldValueType
    {
        Unknown = 0,
        String = 1
    }
    ...
    // 739
    public enum TermGroup_AgiAbsenceMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    // 740
    public enum TermGroup_InvoiceProductUnitConvertMatrixColumns
    {
        Unknown = 0,
        ProductNr = 1,
        ProductName = 2,
    ...
    // 741
    public enum TermGroup_SieExportVoucherSort
    {
        Unknown = 0,
        ByDate = 1,
        ByVoucherNr = 2
    ...
    // 742
    public enum TermGroup_TimeTerminalLogLevel
    {
        Debug = 0,
        Information = 1,
        Warning = 2,
    ...
    // 743
    public enum TermGroup_BygglosenSalaryType
    {
        Unknown = 0,
        TimeSalary = 1,
        PerformanceSalary = 2,
    ...
    // 744
    public enum TermGroup_SupplierInvoiceSource
    {
        Unknown = 0,
        EDI = 1,
        EInvoice = 2,
    ...
    // 745
    public enum TermGroup_SupplierInvoiceStatus
    {
        New = 1,
        InProgress = 2,
    }
    ...
    // 746
    public enum TermGroup_SignatoryContractPermissionType
    {
        Unknown = 0,
        // Core features 1-99
    ...
    // 747
    public enum TermGroup_ExcludeFromWorkTimeWeekCalculationItems
    {
    ...
    // 748
    public enum TermGroup_InventoryMatrixColumns
    {
        Unknown = 0,
        InventoryNumber = 1,
        InventoryName = 2,
    ...
    //749
    public enum TermGroup_FileImportStatus
    {
        InProgress = 1,
        Success = 2,
        Error = 3,
    ...
    // 751
    public enum TermGroup_EmployeeChildMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    // 752
    public enum TermGroup_EmployeePayrollAdditionsMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    // 753
    public enum TermGroup_ProjectBudgetPeriodType
    {
        SinglePeriod = 1,
        Monthly = 2,
        Quarterly = 3,
    ...
    // 754
    public enum TermGroup_AnnualLeaveGroupType
    {
        Unknown = 0,
        Commercial = 1,
        HotelRestaurant = 2,
    ...
    // 756
    public enum TermGroup_TimeScheduleTemplateBlockAbsenceType
    {
        Standard = 0,
        AnnualLeave = 1,
    }
    ...
    // 757
    public enum TermGroup_TimeSchedulePlanningAnnualLeaveBalanceFormat
    {
        Days = 0,
        Hours = 1,
    }
    ...
    // 758
    public enum TermGroup_AnnualLeaveTransactionMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    // 762
    public enum TermGroup_TimeWorkReductionCalculationRule
    {
        UseWorkTimeWeek = 0,
        UseWorkTimeWeekPlusExtraShifts = 1,
        UseWorkTimeWeekPlusAdditionalContract = 2,
    ...
    // 763
    public enum TermGroup_AnnualLeaveTransactionType
    {
        Calculated = 0,
        YearlyBalance = 1,
        ManuallyEarned = 2,
    ...
    //764
    public enum TermGroup_TimeWorkReductionWithdrawalMethod
    {
        NotChoosed = 0,
        PensionDeposit = 1,
        DirectPayment = 2,
	...
	// 765
	public enum TermGroup_DepreciationMatrixColumns
	{
		Unknown = 0,
		InventoryNumber = 1,
		InventoryName = 2,
    ...
    // 766
    public enum TermGroup_TimeSchedulePlanningShiftStartsOnDay
    {
        PreviousDay = -1,
        CurrentDay = 0,
        NextDay = 1,
    ...
    //767
    public enum TermGroup_TimeWorkReductionReconciliationEmployeeStatus
    {
        NotCalculated = 0,
        Created = 1,
        Calculated = 2,
    ...
    //768
    public enum TermGroup_TimeWorkReductionReconciliationResultCode
    {
        Succeeded = 0,
        Deleted = 2,
    ...
    // 771
    public enum TermGroup_SysExtraField
    {
        AveragingOvertimeCalculation = 101,
    ...
    // 772
    public enum TermGroup_TimeCodeRankingOperatorType
    {
        GreaterThan = 0,
        LesserThan = 1,
    }
    ...
    // 773
    public enum TermGroup_TimeScheduleCopyHeadType
    {
        Unknown = 0,
        PrelToDef = 1,
        DefToPrel = 2,
    ...
    // 774
    public enum TermGroup_TimeScheduleCopyRowType
    {
        Default = 0,
    }

    //775
    public enum TermGroup_TimeCodeClassification
    {
        None = 0,
    ...
    //776
    public enum TermGroup_PayrollReportsJobStatus
    {
        Other = 0,
        Manager = 1,
        CEO = 2,
    ...
    //777
    public enum TermGroup_ImportPaymentType
    {
        None = 0,
        CustomerPayment = 1,
        SupplierPayment = 2,
    ...
    //778
    public enum TermGroup_SwapShiftMatrixColumns
    {
        Unknown = 0,
        EmployeeNr = 1,
        EmployeeName = 2,
    ...
    public enum SimpleTextEditorDialogMode
    {
        Base = 0,
        NewTextBlock = 1,
        EditTextBlock = 2,
    ...
    #region TimeCodeTransactionType

    public enum TimeCodeTransactionType
    {
        Unknown = 0,
        Time = 1,
        TimeProject = 2,
    ...
    public enum LeisureCodeAllocationEmployeeStatus
    {
        AllSuccess = 1,
        PartialSuccess = 2,
        AllFailed = 3,
    ...
    public enum LeisureCodeAllocationWeekInvalidation
    {
    ...
    public enum TimeRuleExportImportUnmatchedType
    {
        TimeCode = 1,
        EmployeeGroup = 2,
        TimeScheduleType = 3,
    ...
    public enum AbsenceTypePartTimeOptionpay
    {
        WholeFirstDay = 1,
        WholeLastDay = 2,
    ...
    public enum TimeSchedulePlanningMode
    {
        SchedulePlanning = 1,
        OrderPlanning = 2,
    }

    public enum TimeSchedulePlanningDisplayMode
    {
        User = 1,
        Admin = 2,
        AdminAvailability = 3,
    ...
    public enum DropEmployeeAction
    {
        Cancel = 0,
        New = 1,
        Assign = 2
    ...
    #region TimeStampAdditions

    public enum TimeStampAdditionType
    {
        Unknown = 0,
        TimeScheduleType = 1,
    ...
    // (Duplicate: TermGroup_TimeStampEntryType)
    public enum TimeStampEntryType
    {
        Unknown = 0,
        In = 1,
        Out = 2
    ...
    public enum TimeTerminalSettingType
    {
        Unknown = 0,
    ...
    public enum TimeTerminalSettingDataType
    {
        Unknown = 0,
        String = 1,
        Integer = 2,
    ...
    public enum PayrollGroupSettingType
    {
        None = 0,
    ...
    public enum PayrollPeriodChangeHeadType
    {
        Lock = 1,
        UnLock = 2,
    }
    ...
    public enum PayrollPeriodChangeRowField
    {
    ...
    public enum UserSettingTypeGroup
    {
        All = 0,
        Core = 1,
        Accounting = 2,
    ...
    public enum UserReplacementType
    {
    ...
    public enum CompanySettingType
    {
        ...
        #region Supplier 201-300, 7201-7400
        ...
        #region Billing 401-500, 6001-6500
        ...
        #region Time 501-600, 901-999, 8000-8999
        ...
        #region Base accounts 1001-2000
        ...
        #region InvoiceProduct 1301-1400
        ...
        #region EmployeeGroup 1401-1420
        ...
        #region Base products 2001-3000
    ...
    public enum CompanySettingTypeGroup
    {
        Unknown = 0,
    ...
    public enum LicenseSettingType
    {
        #region SSO (Single Sign On)
    ...
    public enum ApplicationSettingType
    {
        ...
        #region EDI 100-150 (do not rename these)
    ...
    #region XERecipientType

    public enum XEMailRecipientType
    {
        User = 0,
        Group = 1,
        Role = 2,
    ...
    #region XEMailAnswerType

    public enum XEMailAnswerType
    {
        None = 0,
        Yes = 1,
        No = 2,
    ...
    #region BatchUpdate
    public enum BatchUpdateFieldType
    {
        Unknown = 0,
        String = 1,
        Integer = 2,
    ...
    public enum BatchUpdateAccountStd
    {
        AccountType = 1,
        SysVatAccount = 2,
        IsAccrualAccount = 3,
    ...
    public enum BatchUpdateCustomer
    {
        VatType = 1,
        DefaultPricelist = 2,
    ...
    public enum BatchUpdateEmployee
    {
        Active = 1,
        ExternalCode = 7,
    ...
    public enum BatchUpdateInvoiceProduct
    {
        MaterialCode = 1,
        ProductUnit = 2,
        Active = 3,
    ...
    public enum BatchUpdatePayrollProduct
    {
        Active = 1,
        Payed = 2,
    ...
    public enum BatchUpdateSupplier
    {
        Active = 1,
        VatType = 2,
        PaymentCondition = 3,
