...
{
    public class SelectEntry : SoeFormSelectEntry, IEntryControl, IFormControl
	{
		...
		protected override void RenderPostEntryContent(HtmlTextWriter writer)
		{
            ...
            this.RenderFieldSettingIcon(writer, FormId, FieldId, Validation == SelectEntryValidation.NotEmpty);
		}

		#endregion

        public void ConnectDataSource(object dataSource, string dataTextField = "value", string dataValueField = "key")
        {
