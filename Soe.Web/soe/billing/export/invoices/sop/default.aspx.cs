...
namespace SoftOne.Soe.Web.soe.billing.export.invoices.sop
{
    public partial class _default : PageBase
    {
        ...
        {
            this.Feature = Feature.Billing_Export_Invoices_SOP;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dataStorageId > 0 && dataStorageTypeId > 0)
            {
                ...
                if(storage != null && dataStorageTypeId == (int)SoeDataStorageRecordType.SOPCustomerInvoiceExport)
