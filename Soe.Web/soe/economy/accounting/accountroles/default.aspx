<%@ Page Language="C#" Trace="false" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="SoftOne.Soe.Web.soe.economy.accounting.accountroles._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="soeMainContent" runat="server">     
    ...
    <%} else{ %>
        <SOE:AngularHost ID="AngularHost" ModuleName="Economy" AppName="Soe.Economy.Accounting.AccountDims" runat="server" />
    <% } %>
