<%@ Page Language="C#" Trace="false" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="SoftOne.Soe.Web.soe.economy.reconciliation.vouchersearch._default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="soeMainContent" runat="server">
    ...
    <%}
        ...
        {%>
    <SOE:AngularHost ID="AngularHost" ModuleName="Common, Economy" AppName="Soe.Economy.Accounting.Reconciliation" runat="server" />
    <%}%>
