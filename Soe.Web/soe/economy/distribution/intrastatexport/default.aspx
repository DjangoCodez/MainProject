<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="SoftOne.Soe.Web.soe.economy.distribution.intrastatexport._default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="soeMainContent" runat="server">    
    ...
    <%} else {%>
        <SOE:AngularHost ID="AngularHost" ModuleName="Billing" AppName="Soe.Billing.Products.IntrastatExport" runat="server" />
    <%}%>
