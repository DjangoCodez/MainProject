<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="SoftOne.Soe.Web.soe.economy.distribution.saleseu._default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="soeMainContent" runat="server">
    ...
    {%>
        <SOE:AngularHost ID="AngularHost" ModuleName="Economy, Common" AppName="Soe.Economy.Reports.SalesEU" runat="server" />
    <%}%>
