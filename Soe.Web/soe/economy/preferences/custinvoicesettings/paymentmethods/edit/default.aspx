<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="SoftOne.Soe.Web.soe.economy.preferences.custinvoicesettings.paymentmethods.edit._default" %>
    ...
    <SOE:Form ID="Form1" EnableDelete="true" EnableCopy="true" EnablePrevNext="true" runat="server">
		<Tabs>
			<SOE:Tab Type="Edit" runat="server">
				<div>
                    <fieldset>
                        <legend><%=GetText(1851, "Inbetalningsmetod")%></legend>
                        <table>
	                        <SOE:TextEntry
	                            ID="Name"
	                            TermID="1793" 
