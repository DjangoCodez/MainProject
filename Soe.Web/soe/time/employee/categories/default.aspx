<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="SoftOne.Soe.Web.soe.time.employee.categories._default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="soeMainContent" runat="server">	
    ...
    <%} else {%>
        <SOE:AngularHost ID="AngularHost" ModuleName="Common, Economy" AppName="Soe.Common.Categories" runat="server" />        
    <%}%>
