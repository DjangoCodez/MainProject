<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="SoftOne.Soe.Web.soe.time.preferences.salarysettings.pricetype._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="soeMainContent" runat="server">    
    ...
    <%} else {%>
        <SOE:AngularHost ID="AngularHost" ModuleName="Time" AppName="Soe.Time.Payroll.PayrollPriceTypes" runat="server" />
