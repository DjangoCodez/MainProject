...
namespace SoftOne.Soe.Web.soe.time.schedule.planning.employeepost
{
    public partial class _default : PageBase
    {
        ...
        {
            if (!HasRolePermission(Feature.Time_Schedule_SchedulePlanning_EmployeePostDayView, Permission.Readonly) && !HasRolePermission(Feature.Time_Schedule_SchedulePlanning_EmployeePostScheduleView, Permission.Readonly))
