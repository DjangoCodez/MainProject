...
namespace SoftOne.Soe.Web.soe.time.schedule.planning.spaschedule
{
    public partial class _default : PageBase
    {
        ...
        {
            if (!HasRolePermission(Feature.Time_Schedule_SchedulePlanning_DayView, Permission.Readonly) && !HasRolePermission(Feature.Time_Schedule_SchedulePlanning_ScheduleView, Permission.Readonly))
