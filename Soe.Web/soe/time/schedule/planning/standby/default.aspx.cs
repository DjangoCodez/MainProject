...
namespace SoftOne.Soe.Web.soe.time.schedule.planning.standby
{
    public partial class _default : PageBase
    {
        ...
        {
            if (!HasRolePermission(Feature.Time_Schedule_SchedulePlanning_StandbyDayView, Permission.Readonly) && !HasRolePermission(Feature.Time_Schedule_SchedulePlanning_StandbyScheduleView, Permission.Readonly))
