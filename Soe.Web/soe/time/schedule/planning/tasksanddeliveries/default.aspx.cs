...
namespace SoftOne.Soe.Web.soe.time.schedule.planning.tasksanddeliveries
{
    public partial class _default : PageBase
    {
        ...
        {
            if (!HasRolePermission(Feature.Time_Schedule_StaffingNeeds_Tasks, Permission.Readonly) && !HasRolePermission(Feature.Time_Schedule_StaffingNeeds_IncomingDeliveries, Permission.Readonly))
