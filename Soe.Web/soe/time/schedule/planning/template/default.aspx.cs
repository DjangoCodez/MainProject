...
namespace SoftOne.Soe.Web.soe.time.schedule.planning.template
{
    public partial class _default : PageBase
    {
        ...
        {
            if (!HasRolePermission(Feature.Time_Schedule_SchedulePlanning_TemplateDayView, Permission.Readonly) && !HasRolePermission(Feature.Time_Schedule_SchedulePlanning_TemplateScheduleView, Permission.Readonly))
