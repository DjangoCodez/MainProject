...
namespace Soe.WebApi.Controllers.Expense
{
    [RoutePrefix("Expense")]
    public class ExpenseController : SoeApiController
    {
        #region Variables
        ...
        public ExpenseController(ExpenseManager em, TimeEngineManager tem)
        {
            this.em = em;
            this.tem = tem;
        }
